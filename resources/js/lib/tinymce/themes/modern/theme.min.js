!(function (_) {
    ...
    var e,
        ...
        C = function (e, t) {
            e.shortcuts.add("Alt+F9", "", a(t, "menubar")),
                e.shortcuts.add("Alt+F10,F10", "", a(t, "toolbar")),
                e.shortcuts.add("Alt+F11", "", a(t, "elementpath")),
                t.on("cancel", function () {
                    e.focus();
                });
        },
        E = tinymce.util.Tools.resolve("tinymce.geom.Rect"),
                    ...
                    w.each(e.split(/[ ,]/), function (t) {
                        ...
                        "|" === t
                            ...
                            : (o || ((o = { type: "buttongroup", items: [] }), s.push(o)),
                              i.buttons[t] && ((e = t), "function" == typeof (t = i.buttons[e]) && (t = t()), (t.type = t.type || "button"), (t.size = r), (t = b.create(t)), o.items.push(t), i.initialized ? n() : i.on("init", n)));
                    }),
        ...
        V = function (e, t, n, i, r, o) {
            return (o = F({ x: t, y: n, w: o.w, h: o.h })), e && (o = e({ elementRect: F(i), contentAreaRect: F(r), panelRect: o })), o;
        },
        Y = function (x) {
            var i,
                o = function () {
                ...
                n = function (e, t) {
                    ...
                    if (!x.removed) {
                        ...
                        (l = ["bc-tc", "tc-bc", "tl-bl", "bl-tl", "tr-br", "br-tr"]),
                            ...
                            t && s.show(),
                            (d = e.element),
                            (f = I.getPos(x.getContentAreaContainer())),
                            (h = x.dom.getRect(d)),
                            ...
                            (r = h),
                            (i = I.getRect(s.getEl())),
                            (o = I.getRect(x.getContentAreaContainer() || x.getBody()));
                        var g,
                            p,
                            v,
                            b = A.getUiContainerDelta(s).getOr({ x: 0, y: 0 });
                        ...
                        x.inline || (o.w = x.getDoc().documentElement.offsetWidth),
                            x.selection.controlSelection.isResizable(e.element) && r.w < 25 && (r = E.inflate(r, 0, 8)),
                            (n = E.findBestRelativePosition(i, r, o, l)),
                            (r = E.clamp(r, o)),
                            n
                                ? ((a = E.relativePosition(i, r, n)), U(s, V(u, a.x, a.y, r, o, i)))
                                : ((o.h += i.h),
                                  (r = E.intersect(o, r))
                                      ? (n = E.findBestRelativePosition(i, r, o, ["bc-tc", "bl-tl", "br-tr"]))
                                          ? ((a = E.relativePosition(i, r, n)), U(s, V(u, a.x, a.y, r, o, i)))
                                          : U(s, V(u, r.x, r.y, r, o, i))
                                      : s.hide()),
                            (g = s),
                            (v = function (e, t) {
                                return e === t;
                ...
                a ||
                    w.each(n, function (e, t) {
                        ...
                        e.context !== i ||
                            ...
                            ("before" === e.separator && s.push({ name: "|", item: { text: "|" } }), e.prependToContext ? s.unshift(ie(t, e)) : s.push(ie(t, e)), "after" === e.separator && s.push({ name: "|", item: { text: "|" } }));
                    }),
                (r.menu = G(
                    ((l = t),
                    (u = Z(s, function (e) {
        ...
        ue = function (e, t, n) {
            ...
            (i = e.getContainer()),
                ...
                (o = le(i)),
                (s = le(r)),
                null !== t && ((t = Math.max(e.getParam("min_width", 100, "number"), t)), (t = Math.min(e.getParam("max_width", 65535, "number"), t)), ae.setStyle(i, "width", t + (o.width - s.width)), ae.setStyle(r, "width", t)),
                (n = Math.max(e.getParam("min_height", 100, "number"), n)),
                (n = Math.min(e.getParam("max_height", 65535, "number"), n)),
                ae.setStyle(r, "height", n),
                x(e);
        },
        ce = ue,
        de = function (e, t, n) {
        ...
        me = function (c, d, f) {
            return function (e) {
                ...
                (i = d),
                    ...
                    l && l.visible()
                        ? (he(u, l, "onhide"), l.hide(), s.active(!1))
                        : (l ? l.show() : ((l = b.create({ type: "container", name: d, layout: "stack", classes: "sidebar-panel", html: "" })), a.prepend(l), he(u, l, "onrender")), he(u, l, "onshow"), s.active(!0)),
                    x(c);
            };
        },
        ge = function (e) {
                ...
                items: [
                    {
                        ...
                        items: w.map(n.sidebars, function (e) {
                            var t = e.settings;
                            return { type: "button", icon: t.icon, image: t.image, tooltip: t.tooltip, onclick: me(n, e.name, n.sidebars) };
                        }),
                    },
                ],
            };
        ...
        xe = function (t, e, n) {
            var i, r, o, s, a;
            if (
                (!1 === g(t) && n.skinUiCss ? be.styleSheetLoader.load(n.skinUiCss, ve(t)) : ve(t)(),
                (i = e.panel = b.create({
                    type: "panel",
                    role: "application",
                    classes: "tinymce",
                    ...
                    border: 1,
                    items: [
                        { type: "container", classes: "top-part", items: [!1 === d(t) ? null : { type: "menubar", border: "0 0 1 0", items: se(t) }, z(t, f(t))] },
                        ge(t) ? ((s = t), { type: "panel", layout: "stack", classes: "edit-aria-container", border: "1 0 0 0", items: [ye("0"), pe(s)] }) : ye("1 0 0 0"),
                    ],
                })),
                A.setUiContainer(t, i),
                "none" !== p(t) &&
                    (r = {
                        type: "resizehandle",
                        direction: p(t),
            ...
            return (
                ...
                n.width && be.setStyle(i.getEl(), "width", n.width),
        ...
        Re = {
            ...
            getPos: function (e, t) {
                return v.DOM.getPos(e, t || Re.getContainer());
            },
            getContainer: function () {
                return fe.container ? fe.container : _.document.body;
            },
        ...
        Ce = function (e) {
            return "static" === Re.getRuntimeStyle(e, "position");
        },
        Ee = function (e) {
    ...
    function ke(e, t, n) {
        ...
        return (
            (d = He()),
            (o = (r = Re.getPos(t, A.getUiContainer(e))).x),
            (s = r.y),
            Ee(e) && Ce(_.document.body) && ((o -= d.x), (s -= d.y)),
            (i = e.getEl()),
            (a = (f = Re.getSize(i)).width),
            (l = f.height),
            (u = (f = Re.getSize(t)).width),
            (c = f.height),
            "b" === (n = (n || "").split(""))[0] && (s += c),
            "r" === n[1] && (o += u),
    ...
    var He = function () {
        ...
        Se = function (e) {
            var t,
                n = A.getUiContainer(e);
            return n && !Ee(e) ? { x: 0, y: 0, w: (t = n).scrollWidth - 1, h: t.scrollHeight - 1 } : He();
        },
        Te = {
            testMoveRel: function (e, t) {
                for (var n = Se(this), i = 0; i < t.length; i++) {
                    var r = ke(this, e, t[i]);
                    if (Ee(this)) {
            ...
            moveTo: function (e, t) {
                ...
                return (
                    s && Ce(s) && !Ee(n) && ((e -= s.scrollLeft), (t -= s.scrollTop)),
                    s && ((e += 1), (t += 1)),
    ...
    function De() {}
    function Oe(e) {
        (this.cls = []), (this.cls._map = {}), (this.onchange = e || De), (this.prefix = "");
    }
            ...
            init: function (e) {
                ...
                function a(e, t) {
                    var n,
                        ...
                        o = [];
                    do {
                        if ((Ie.exec(""), (i = Ie.exec(e)) && ((e = i[3]), o.push(i[1]), i[2]))) {
                            n = i[3];
                            break;
                        }
                    } while (i);
    ...
    var Xe = tinymce.util.Tools.resolve("tinymce.util.Observable");
    function je(e) {
        return 0 < e.nodeType;
    }
    var Je,
        ...
        Ke = Me.extend({
            ...
            init: function (e) {
                var t, n;
                for (t in (e = e || {})) (n = e[t]) instanceof qe && (e[t] = n.create(this, t));
                this.data = e;
            },
            set: function (t, n) {
                var i,
                    r,
                    o = this.data[t];
                if ((n instanceof qe && (n = n.create(this, t)), "object" == typeof t)) {
        ...
        it = {
            ...
            init: function (t) {
                ...
                (i.settings = t = w.extend({}, i.Defaults, t)),
                    ...
                    (i._elmCache = {}),
                    (i.$ = we),
                    (i.state = new Ke({ visible: !0, active: !1, disabled: !1, value: "" })),
                    (i.data = new Ke(t.data)),
                    (i.classes = new Oe(function () {
                    ...
                    (i.settings = t),
                    (i.borderBox = Pe(t.border)),
                    (i.paddingBox = Pe(t.padding)),
                    (i.marginBox = Pe(t.margin)),
                    t.hidden && i.hide();
            },
            Properties: "parent,name",
            getContainerElm: function () {
                var e = A.getUiContainer(this);
                return e || Re.getContainer();
            },
            ...
            initLayoutRect: function () {
                var e,
                    ...
                    d = c.settings,
                    f = c.getEl();
                (e = c.borderBox = c.borderBox || We(f, "border")),
                    (c.paddingBox = c.paddingBox || We(f, "padding")),
                    (c.marginBox = c.marginBox || We(f, "margin")),
                    (u = Re.getSize(f)),
                    (a = d.minWidth),
                    (l = d.minHeight),
                    (r = a || u.width),
                    ...
                    e
                        ? ((i = a.deltaW),
                          ...
                          ((t = s._lastLayoutRect).x === a.x && t.y === a.y && t.w === a.w && t.h === a.h) ||
                              ((o = Ge.repaintControls) && o.map && !o.map[s._id] && (o.push(s), (o.map[s._id] = !0)), (t.x = a.x), (t.y = a.y), (t.w = a.w), (t.h = a.h)),
                          s)
                        : a
                );
            },
            ...
            updateLayoutRect: function () {
                var e = this;
                (e.parent()._lastRect = null), Re.css(e.getEl(), { width: "", height: "" }), (e._layoutRect = e._lastRepaintRect = e._lastLayoutRect = null), e.initLayoutRect();
            },
            on: function (e, t) {
                var n,
                    i,
            ...
            remove: function () {
                ...
                r &&
                    ...
                    r.items().set(t),
                    (r._lastRect = null)),
                    n._eventsRoot && n._eventsRoot === n && we(i).off();
    ...
    function ot(a) {
        ...
        if ((i = a._nativeEvents)) {
            ...
            for (r in (d || (d = l._delegates = {}), i)) {
                if (!i) return !1;
                "wheel" !== r || tt
                    ? ("mouseenter" === r || "mouseleave" === r ? l._hasMouseEnter || (we(l.getEl()).on("mouseleave", s).on("mouseover", u), (l._hasMouseEnter = 1)) : d[r] || (we(l.getEl()).on(r, o), (d[r] = !0)), (i[r] = !1))
                    : et
                    ? we(a.getEl()).on("mousewheel", c)
                    : we(a.getEl()).on("DOMMouseScroll", c);
            }
        }
    }
        ...
        ct = st.extend({
            init: function (e) {
                ...
                t._super(e),
                    ...
                    (t._layout = b.create((e.layout || "") + "layout")),
            ...
            postRender: function () {
                ...
                return (
                    ...
                    t.parent() || (t.keyboardNav = lt({ root: t })),
                    t
                );
            },
            initLayoutRect: function () {
    ...
    function ft(e, h) {
        ...
        (t = function (e) {
            ...
            dt(e),
                ...
                (m = we("<div></div>").css({ position: "absolute", top: 0, left: 0, width: f.width, height: f.height, zIndex: 2147483647, opacity: 1e-4, cursor: d }).appendTo(x.body)),
                we(x).on("mousemove touchmove", v).on("mouseup touchend", p),
                h.start(e);
        }),
            (v = function (e) {
                        ...
                        (function () {
                            function e(s, a, l, u, c) {
                                var d,
                                    e = p._id + "-scroll" + s,
                                    t = p.classPrefix;
                                we(p.getEl()).append('<div id="' + e + '" class="' + t + "scrollbar " + t + "scrollbar-" + s + '"><div id="' + e + 't" class="' + t + 'scrollbar-thumb"></div></div>'),
    ...
    function Rt() {
        ht ||
            ...
            we(_.document).on("click touchstart", ht));
    }
    function Ct(r) {
        var e = Re.getViewPort().y;
        function t(e, t) {
            for (var n, i = 0; i < xt.length; i++) if (xt[i] !== r) for (n = xt[i].parent(); n && (n = n.parent()); ) n === r && xt[i].fixed(e).moveBy(0, t).repaint();
        }
        r.settings.autofix &&
            (r.state.get("fixed")
    ...
    function Et(e, t) {
        var n,
            ...
            r = kt.zIndex || 65535;
        if (e) wt.push(t);
        else for (n = wt.length; n--; ) wt[n] === t && wt.splice(n, 1);
        if (wt.length) for (n = 0; n < wt.length; n++) wt[n].modal && (r++, (i = wt[n])), (wt[n].getEl().style.zIndex = r), (wt[n].zIndex = r), r++;
    ...
    var kt = bt.extend({
            ...
            i._super(e),
                    ...
                    (function () {
                        if (!gt) {
                            var e = _.document.documentElement,
                                ...
                                n = e.clientHeight;
                            (gt = function () {
                                (_.document.all && t === e.clientWidth && n === e.clientHeight) || ((t = e.clientWidth), (n = e.clientHeight), kt.hideAll());
                            }),
                                we(_.window).on("resize", gt);
                        }
                    })(),
                    xt.push(i)),
                e.autofix &&
                    (mt ||
                        ((mt = function () {
                            var e;
                            for (e = xt.length; e--; ) Ct(xt[e]);
                        }),
                        we(_.window).on("scroll", mt)),
                    i.on("move", function () {
                        Ct(this);
                    })),
                i.on("postrender show", function (e) {
                    if (e.control === i) {
                        ...
                        i.modal &&
                            !pt &&
                            ((t = we("#" + n + "modal-block", i.getContainerElm()))[0] || (t = we('<div id="' + n + 'modal-block" class="' + n + "reset " + n + 'fade"></div>').appendTo(i.getContainerElm())),
        ...
        hide: function () {
            return Ht(this), Et(!1, this), this._super();
        },
        hideAll: function () {
            kt.hideAll();
        },
    ...
    var St = function (s, n, e) {
            ...
            c = function () {
                ...
                a
                    ...
                    : ((a = n.panel = b.create({
                          ...
                          border: 1,
                          items: [!1 === d(s) ? null : { type: "menubar", border: "0 0 1 0", items: se(s) }, z(s, f(s))],
                      })),
                      A.setUiContainer(s, a),
                      R(s),
        ...
        return (
            ...
            s.on("focus", function () {
                !1 === g(s) && e.skinUiCss ? l.styleSheetLoader.load(e.skinUiCss, c, c) : c();
            }),
            s.on("blur hide", u),
            s.on("remove", function () {
                a && (a.remove(), (a = null));
            }),
            !1 === g(s) && e.skinUiCss ? l.styleSheetLoader.load(e.skinUiCss, ve(s)) : ve(s)(),
            {}
        );
    };
    function Tt(i, r) {
    ...
    var Mt = function (e, t) {
            ...
            e.on("ProgressState", function (e) {
                (n = n || new Tt(t.panel.getEl("body"))), e.state ? n.show(e.time) : n.hide();
            });
        },
        Nt = function (e, t, n) {
            var i = (function (e) {
            ...
            return i && ((n.skinUiCss = i + "/skin.min.css"), e.contentCSS.push(i + "/content" + (e.inline ? ".inline" : "") + ".min.css")), Mt(e, t), e.getParam("inline", !1, "boolean") ? St(e, t, n) : xe(e, t, n);
        },
        Pt = st.extend({
            Mixins: [Te],
        ...
        Wt = st.extend({
            ...
            tooltip: function () {
                return this._tooltip || ((this._tooltip = new Pt({ type: "tooltip" })), A.inheritUiContainer(this, this._tooltip), this._tooltip.renderTo()), this._tooltip;
            },
            postRender: function () {
                var e = this,
                    t = e.settings;
        ...
        At = st.extend({
            ...
            postRender: function () {
                ...
                return (
                    u.setTimeout(function () {
                        e.$el.addClass(e.classPrefix + "in"), Ot(e, e.state.get("text"));
                    }, 100),
                    e._super()
                );
            },
            bindStates: function () {
                ...
                return (
                    t.state.on("change:text", function (e) {
                        (t.getEl().firstChild.innerHTML = e.value), Ot(t, e.value);
                    }),
                    t.progressBar &&
                        (t.progressBar.bindStates(),
                        t.progressBar.state.on("change:value", function (e) {
                            Ot(t, t.state.get("text"));
                        })),
                    t._super()
                );
            },
    ...
    function Bt(o) {
        ...
        return {
            open: function (e, t) {
                var n,
                    i = w.extend(e, { maxWidth: ((n = s(o)), Re.getSize(n).width) }),
                    r = new At(i);
                return (
                    0 < (r.args = i).timeout &&
    ...
    function It(e) {
        var t,
            n = we("meta[name=viewport]")[0];
        !1 !== fe.overrideViewPort &&
            (n || ((n = _.document.createElement("meta")).setAttribute("name", "viewport"), _.document.getElementsByTagName("head")[0].appendChild(n)),
            (t = n.getAttribute("content")) && void 0 !== zt && (zt = t),
            n.setAttribute("content", e ? "width=device-width,initial-scale=1.0,user-scalable=0,minimum-scale=1.0,maximum-scale=1.0" : zt));
    }
    function Ft(e, t) {
        (function () {
            for (var e = 0; e < Lt.length; e++) if (Lt[e]._fullscreen) return !0;
            return !1;
        })() &&
            !1 === t &&
            we([_.document.documentElement, _.document.body]).removeClass(e + "fullscreen");
    }
    var Ut = kt.extend({
        modal: !0,
        Defaults: {
        ...
        init: function (e) {
            ...
            n._super(e),
                ...
                n.state.set("fixed", !0),
                e.buttons &&
                    ((n.statusbar = new bt({ layout: "flex", border: "1 0 0 0", spacing: 3, padding: 10, align: "center", pack: n.isRtl() ? "start" : "end", defaults: { type: "button" }, items: e.buttons })),
                    n.statusbar.classes.add("foot"),
                    n.statusbar.parent(n)),
                n.on("click", function (e) {
                    var t = n.classPrefix + "close";
                    (Re.hasClass(e.target, t) || Re.hasClass(e.target.parentNode, t)) && n.close();
                }),
        ...
        recalc: function () {
            var e,
                ...
                r = this,
                o = r.statusbar;
            r._fullscreen && (r.layoutRect(Re.getWindowSize()), (r.layoutRect().contentH = r.layoutRect().innerH)),
                r._super(),
                (e = r.layoutRect()),
        ...
        fullscreen: function (e) {
            ...
            if (e !== i._fullscreen)
                if (
                    (we(_.window).on("resize", function () {
                        var e;
                        if (i._fullscreen)
                            if (n)
                                i._timer ||
                                    (i._timer = u.setTimeout(function () {
                                        var e = Re.getWindowSize();
                                        i.moveTo(0, 0).resizeTo(e.w, e.h), (i._timer = 0);
                                    }, 50));
                            else {
                                e = new Date().getTime();
                                var t = Re.getWindowSize();
                    ...
                    (i._initial = { x: t.x, y: t.y, w: t.w, h: t.h }),
                        ...
                        we([r, _.document.body]).addClass(o + "fullscreen"),
                        i.classes.add("fullscreen");
                    var s = Re.getWindowSize();
                    i.moveTo(0, 0).resizeTo(s.w, s.h);
                } else
                    (i.borderBox = Pe(i.settings.border)),
                        (i.getEl("head").style.display = ""),
                        (t.deltaH += t.headerH),
                        we([r, _.document.body]).removeClass(o + "fullscreen"),
        ...
        postRender: function () {
            ...
            setTimeout(function () {
                ...
                n.focus(),
                (this.dragHelper = new ft(n._id + "-dragh", {
                    start: function () {
        ...
        remove: function () {
            var e,
                t = this;
            for (t.dragHelper.destroy(), t._super(), t.statusbar && this.statusbar.remove(), Ft(t.classPrefix, !1), e = Lt.length; e--; ) Lt[e] === t && Lt.splice(e, 1);
            It(0 < Lt.length);
        },
    ...
    !(function () {
        if (!fe.desktop) {
            ...
            u.setInterval(function () {
                ...
                (n.w === e && n.h === t) || ((n = { w: e, h: t }), we(_.window).trigger("resize"));
            }, 100);
        }
        we(_.window).on("resize", function () {
            var e,
                t,
                n = Re.getWindowSize();
            for (e = 0; e < Lt.length; e++) (t = Lt[e].layoutRect()), Lt[e].moveTo(Lt[e].settings.x || Math.max(0, n.w / 2 - t.w / 2), Lt[e].settings.y || Math.max(0, n.h / 2 - t.h / 2));
        });
    })();
    var Vt,
        Yt,
        ...
        qt = Ut.extend({
            ...
            Statics: {
                ...
                msgBox: function (e) {
                    ...
                    switch (e.buttons) {
                        ...
                        case qt.YES_NO_CANCEL:
                            (t = [n("Yes", 1, !0), n("No", 0)]), e.buttons === qt.YES_NO_CANCEL && t.push(n("Cancel", -1));
                            break;
                        default:
                            t = [n("Ok", !0, !0)];
                    }
                ...
                alert: function (e, t) {
                    return "string" == typeof e && (e = { text: e }), (e.callback = t), qt.msgBox(e);
                },
                confirm: function (e, t) {
                    return "string" == typeof e && (e = { text: e }), (e.callback = t), (e.buttons = qt.OK_CANCEL), qt.msgBox(e);
                },
            },
        }),
        Xt = function (n) {
        ...
        Kt = Gt.extend({
            ...
            postRender: function () {
                var n = this,
                    t = Re.create("input", { type: "file", id: n._id + "-browse", accept: n.settings.accept });
                n._super(),
                    we(t).on("change", function (e) {
        ...
        en = tinymce.util.Tools.resolve("tinymce.util.VK"),
        tn = Wt.extend({
            init: function (i) {
                var r = this;
                r._super(i),
            ...
            showMenu: function () {
                ...
                t.menu ||
                    ...
                    (t.menu = b.create(e).parent(t).renderTo(t.getContainerElm())),
                    t.fire("createmenu"),
                    t.menu.reflow(),
            ...
            repaint: function () {
                var e,
                    ...
                    s = 0,
                    a = i.firstChild;
                n.statusLevel() && "none" !== n.statusLevel() && (s = parseInt(Re.getRuntimeStyle(a, "padding-right"), 10) - parseInt(Re.getRuntimeStyle(a, "padding-left"), 10)), (e = r ? o.w - Re.getSize(r).width - 10 : o.w - 10);
                var l = _.document;
                return l.all && (!l.documentMode || l.documentMode <= 8) && (t = n.layoutRect().h - 2 + "px"), we(a).css({ width: e - s, lineHeight: t }), n._super(), n;
            },
            postRender: function () {
                var t = this;
                return (
                    we(this.getEl("inp")).on("change", function (e) {
            ...
            showAutoComplete: function (e, i) {
                var r = this;
                if (0 !== e.length) {
                    r.menu ? r.menu.items().remove() : (r.menu = b.create({ type: "menu", classes: "combobox-menu", layout: "flow" }).parent(r).renderTo()),
                        w.each(e, function (e) {
                            var t, n;
                            r.menu.add({
                                text: e.title,
            ...
            bindStates: function () {
                ...
                r.state.on("change:value", function (e) {
                    ...
                    r.state.on("change:statusLevel", function (e) {
                        var t = r.getEl("status"),
                            n = r.classPrefix,
                            i = e.value;
                        Re.css(t, "display", "none" === i ? "none" : ""),
                            Re.toggleClass(t, n + "i-checkmark", "ok" === i),
                            Re.toggleClass(t, n + "i-warning", "warn" === i),
                            Re.toggleClass(t, n + "i-error", "error" === i),
                            r.classes.toggle("has-status", "none" !== i),
                            r.repaint();
                    }),
                    Re.on(r.getEl("status"), "mouseleave", function () {
                        r.tooltip().hide();
                    }),
                ...
                return (
                    r.on("keydown", function (e) {
                        var t = e.keyCode;
                        "INPUT" === e.target.nodeName && (t === en.DOWN ? (e.preventDefault(), r.fire("autocomplete"), n(0, r.menu)) : t === en.UP && (e.preventDefault(), n(-1, r.menu)));
                    }),
                    r._super()
                );
            },
        ...
        sn = rn.extend({
            ...
            postRender: function () {
                ...
                return (
                    t.on("click", function (e) {
                        (e.aria && "down" === e.aria.key) || e.control !== t || on.getParent(e.target, "." + t.classPrefix + "open") || (e.stopImmediatePropagation(), n.call(t, e));
                    }),
        ...
        ln = Wt.extend({
            ...
            postRender: function () {
                ...
                function c(e, t) {
                    var n = (360 - e.h) / 360;
                    Re.css(r, { top: 100 * n + "%" }), t || Re.css(s, { left: e.s + "%", top: 100 - e.v + "%" }), (o.style.background = an({ s: 100, v: 100, h: e.h }).toHex()), a.color().parse({ s: e.s, v: e.v, h: e.h });
                }
                function e(e) {
                    var t;
                ...
                (i = a.getEl("h")),
                    ...
                    a._super(),
                    (a._svdraghelper = new ft(a._id + "-sv", { start: e, drag: e })),
                    (a._hdraghelper = new ft(a._id + "-h", { start: t, drag: t })),
                    a._repaint();
            },
            rgb: function () {
        ...
        un = Wt.extend({
            ...
            renderHtml: function () {
                ...
                return (
                    ...
                    (t = Re.create("div", e, "<span>" + this.translate(n.text) + "</span>")),
                    n.height && Re.css(t, "height", n.height + "px"),
                    n.width && Re.css(t, "width", n.width + "px"),
                ...
                i.settings.formItemDefaults || (i.settings.formItemDefaults = { layout: "flex", autoResize: "overflow", defaults: { flex: 1 } }),
                    e.each(function (e) {
                        var t,
                            n = e.settings.label;
                        n &&
                            (((t = new fn(w.extend({ items: { type: "label", id: e._id + "-l", text: n, flex: 0, forId: e._id, disabled: e.disabled() } }, i.settings.formItemDefaults))).type = "formitem"),
        ...
        vn = {
            ...
            fromPoint: function (e, t, n) {
                var i = e.dom();
                return D.from(i.elementFromPoint(t, n)).map(pn);
            },
        },
        bn = (_.Node.ATTRIBUTE_NODE, _.Node.CDATA_SECTION_NODE, _.Node.COMMENT_NODE, _.Node.DOCUMENT_NODE),
        yn = (_.Node.DOCUMENT_TYPE_NODE, _.Node.DOCUMENT_FRAGMENT_NODE, _.Node.ELEMENT_NODE),
        xn =
            (_.Node.TEXT_NODE,
        ...
        kn = function (e) {
            var t = e.current;
            return { current: t, version: e.version, isEdge: En("Edge", t), isChrome: En("Chrome", t), isIE: En("IE", t), isOpera: En("Opera", t), isFirefox: En(Cn, t), isSafari: En("Safari", t) };
        },
        Hn = {
            unknown: function () {
                return kn({ current: undefined, version: Rn.unknown() });
            },
            nu: kn,
            edge: H("Edge"),
            chrome: H("Chrome"),
        ...
        Wn = function (e) {
            var t = e.current;
            return { current: t, version: e.version, isWindows: Pn(Sn, t), isiOS: Pn("iOS", t), isAndroid: Pn(Tn, t), isOSX: Pn("OSX", t), isLinux: Pn("Linux", t), isSolaris: Pn(Mn, t), isFreeBSD: Pn(Nn, t) };
        },
        Dn = {
            unknown: function () {
                return Wn({ current: undefined, version: Rn.unknown() });
            },
            nu: Wn,
            windows: H(Sn),
            ios: H("iOS"),
        ...
        Fn = [
            {
                ...
                search: function (e) {
                    return Ln(e, "edge/") && Ln(e, "chrome") && Ln(e, "safari") && Ln(e, "applewebkit");
                },
            },
            {
                name: "Chrome",
                ...
                search: function (e) {
                    return Ln(e, "chrome") && !Ln(e, "chromeframe");
                },
            },
            {
                name: "IE",
                ...
                search: function (e) {
                    return Ln(e, "msie") || Ln(e, "trident");
                },
            },
            { name: "Opera", versionRegexes: [zn, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: In("opera") },
            { name: "Firefox", versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: In("firefox") },
            {
                name: "Safari",
                versionRegexes: [zn, /.*?cpu os ([0-9]+)_([0-9]+).*/],
                search: function (e) {
                    return (Ln(e, "safari") || Ln(e, "mobile/")) && Ln(e, "applewebkit");
                },
            },
        ],
        Un = [
            { name: "Windows", search: In("win"), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
            {
                name: "iOS",
                search: function (e) {
                    return Ln(e, "iphone") || Ln(e, "ipad");
                },
                versionRegexes: [/.*?version\/\ ?([0-9]+)\.([0-9]+).*/, /.*cpu os ([0-9]+)_([0-9]+).*/, /.*cpu iphone os ([0-9]+)_([0-9]+).*/],
            },
            { name: "Android", search: In("android"), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/] },
            { name: "OSX", search: In("os x"), versionRegexes: [/.*?os\ x\ ?([0-9]+)_([0-9]+).*/] },
        ...
        Yn = function (e) {
            var t,
                ...
                f = Vn.browsers(),
                h = Vn.oses(),
                m = An(f, e).fold(Hn.unknown, Hn.nu),
                g = Bn(h, e).fold(Dn.unknown, Dn.nu);
            return {
                browser: m,
                os: g,
                deviceType:
                    ...
                    { isiPad: H(r), isiPhone: H(o), isTablet: H(l), isPhone: H(c), isTouch: H(u), isAndroid: t.isAndroid, isiOS: t.isiOS, isWebView: H(d) }),
            };
        },
        $n =
            (($t = !(Vt = function () {
            ...
            function () {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                return $t || (($t = !0), (Yt = Vt.apply(null, e))), Yt;
            }),
        qn = yn,
        Xn = bn,
        jn = function (e) {
            return (e.nodeType !== qn && e.nodeType !== Xn) || 0 === e.childElementCount;
        },
        Jn =
            ($n().browser.isIE(),
            (function () {
        ...
        ti = function (e) {
            return e.id ? e.id : ((t = "h"), (n = new Date().getTime()), t + "_" + Math.floor(1e9 * Math.random()) + ++gn + String(n));
            var t, n;
        },
        ni = function (e) {
            return (t = e) && "A" === t.nodeName && (t.id || t.name) && ri(e);
            var t;
        },
        ii = function (e) {
        ...
        si = function (e) {
            var t,
                n = ti(e);
            return Qn("header", ei(e), "#" + n, ii((t = e)) ? parseInt(t.nodeName.substr(1), 10) : 0, function () {
                e.id = n;
            });
        },
        ai = function (e) {
        ...
        li = function (e) {
            ...
            return (
                ...
                G(
                    ...
                    jn(s) ? [] : G(s.querySelectorAll(r), vn.fromDom)),
                    function (e) {
                        return e.dom();
                    }
                )
        ...
        ui = function (e) {
            return 0 < Jn(e.title).length;
        },
        ci = function (e) {
            var t,
                n = li(e);
            return Z(((t = n), G(Z(t, oi), si)).concat(G(Z(n, ni), ai)), ui);
        },
        di = {},
        fi = function (e) {
        ...
        hi = function (e, t) {
            return { title: e, value: { title: e, url: t, attach: k } };
        },
        mi = function (e, t, n) {
            var i = t in e ? e[t] : n;
            return !1 === i ? null : i;
        ...
        gi = function (e, i, r, t) {
            var n,
                ...
                d = function (e) {
                    ...
                    return w.map(n, function (e) {
                        return { title: e, value: { title: e, url: e, attach: k } };
                    });
                },
                f = function (t) {
                    var e,
            ...
            return !1 === t.typeahead_urls
                ...
                ? ((n = [
                      vi(e, d(di)),
                      vi(e, f("header")),
                      vi(e, ((a = f("anchor")), (l = mi(t, "anchor_top", "#top")), (u = mi(t, "anchor_bottom", "#bottom")), null !== l && a.unshift(hi("<top>", l)), null !== u && a.push(hi("<bottom>", u)), a)),
                  ]),
                  (o = function (e, t) {
        ...
        pi = function (e, t) {
            var n,
                ...
                r,
                o = di[t];
            /^https?/.test(e) && (o ? ((n = o), (i = e), (r = j(n, i)), -1 === r ? D.none() : D.some(r)).isNone() && (di[t] = o.slice(0, 5).concat(e)) : (di[t] = [e]));
        },
        vi = function (e, t) {
            var n = e.toLowerCase(),
        ...
        yi = tn.extend({
            ...
            init: function (e) {
                var t,
                    ...
                    f = e.filetype;
                (e.spellcheck = !1),
                    (i = d.file_picker_types || d.file_browser_callback_types) && (i = w.makeMap(i, /[, ]/)),
                    (i && !i[f]) ||
                        (!(n = d.file_picker_callback) || (i && !i[f])
                            ...
                            : (t = function () {
                                  ...
                                  (e = w.extend({ filetype: f }, e)),
                                      n.call(
                                          c,
                                          function (e, t) {
                                              u.value(e).fire("change", { meta: t });
                                          },
                                          u.value(),
                                          e
                                      );
                    ...
                    r.on("selectitem", function (e) {
                        ...
                        "image" === a ? r.fire("change", { meta: { alt: i, attach: t.attach } }) : r.fire("change", { meta: { text: i, attach: t.attach } }), r.focus();
                    }),
                    r.on("click", function (e) {
                    ...
                    r.on("PostRender", function () {
                        r.getRoot().on("submit", function (e) {
                            e.isDefaultPrevented() || pi(r.value(), a);
                        });
                    }),
                    bi(u, d, f);
            },
        ...
        Ri = function (e, t) {
            return (n = t), (r = (i = e) === undefined ? _.document : i.dom()), jn(r) ? D.none() : D.from(r.querySelector(n)).map(vn.fromDom);
            var n, i, r;
        },
        Ci = function (e, t) {
            return function () {
        ...
        Hi = function (i) {
            var t = ["alignleft", "aligncenter", "alignright", "alignjustify"],
                r = "alignleft",
                e = [
                    { text: "Left", icon: "alignleft", onclick: Ci(i, "alignleft") },
                    { text: "Center", icon: "aligncenter", onclick: Ci(i, "aligncenter") },
                    { text: "Right", icon: "alignright", onclick: Ci(i, "alignright") },
                    { text: "Justify", icon: "alignjustify", onclick: Ci(i, "alignjustify") },
                ];
            i.addMenuItem("align", { text: "Align", menu: e }),
                ...
                w.each(
                    ...
                    function (e, t) {
                        i.addButton(t, { active: !1, tooltip: e[0], cmd: e[1], onPostRender: ki(i, t) });
                    }
                );
        },
        Si = function (e) {
                    ...
                    l.on("init nodeChange", function (e) {
                        var t,
                            ...
                            s =
                                ...
                                w.each(t, function (e) {
                                    i || Si(e.value).toLowerCase() !== Si(r).toLowerCase() || (i = e.value);
                                }),
                                i);
                        a.value(s || null), !s && o && a.text(Si(o));
                    });
            };
        },
        Mi = function (n) {
                    ...
                    onPostRender:
                        ...
                        function () {
                            ...
                            s.on("init nodeChange", function (e) {
                                var t, n, i, r;
                                if ((t = s.queryCommandValue("FontSize"))) for (i = 3; !r && 0 <= i; i--) (n = Pi(t, i)), (r = Wi(a, n, t));
        ...
        Bi = function (n, e) {
            ...
            return (
                e.items().each(function (e) {
                    e.menu && e.visible(0 < Bi(n, e.menu)), !e.menu && e.settings.menu && e.visible(0 < Ai(n, e.settings.menu));
                ...
                u =
                    ...
                    }),
                    {
                        ...
                        itemDefaults: {
                            ...
                            onclick: function () {
                                this.settings.format && Ci(i, this.settings.format)(), this.settings.cmd && i.execCommand(this.settings.cmd);
                            },
                        },
                    });
            (n = u),
                ...
                (a = e).addButton("styleselect", {
                    ...
                    menu: l,
                    onShowMenu: function () {
                        a.settings.style_formats_autohide && Bi(a, this.menu);
                    },
                });
        },
        zi = function (n, e) {
        ...
        Ii = function (e) {
            ...
            e.addMenuItem("blockformats", {
                ...
                e.addButton("formatselect", zi(e, i));
        },
        Fi = function (t, e) {
            var n, i;
        ...
        Vi = function (e) {
            var t = Z(e, function (e, t, n) {
                return !Ui(e) || !Ui(n[t - 1]);
            });
            return Z(t, function (e, t, n) {
                return !Ui(e) || (0 < t && t < n.length - 1);
            });
        },
        Yi = function (e) {
            var t,
        ...
        $i = function (e) {
            ...
            (t = e).addButton("insert", {
                ...
                oncreatemenu: function () {
                    this.menu.add(Yi(t)), this.menu.renderNew();
                },
            });
        },
        qi = function (e) {
            ...
            (n = e),
                w.each({ bold: "Bold", italic: "Italic", underline: "Underline", strikethrough: "Strikethrough", subscript: "Subscript", superscript: "Superscript" }, function (e, t) {
                    n.addButton(t, { active: !1, tooltip: e, onPostRender: ki(n, t), onclick: Ci(n, t) });
                }),
                (i = e),
                w.each(
                    {
                ...
                w.each({ blockquote: ["Blockquote", "mceBlockQuote"], subscript: ["Subscript", "Subscript"], superscript: ["Superscript", "Superscript"] }, function (e, t) {
                    r.addButton(t, { active: !1, tooltip: e[0], cmd: e[1], onPostRender: ki(r, t) });
                });
        },
        Xi = function (e) {
            var n;
            qi(e),
                ...
                n.addMenuItem("codeformat", { text: "Code", icon: "code", onclick: Ci(n, "code") });
        },
        ji = function (n, i) {
            return function () {
                var e = this,
        ...
        Ji = function (e) {
            var t, n;
            (t = e).addMenuItem("undo", { text: "Undo", icon: "undo", shortcut: "Meta+Z", onPostRender: ji(t, "undo"), cmd: "undo" }),
                t.addMenuItem("redo", { text: "Redo", icon: "redo", shortcut: "Meta+Y", onPostRender: ji(t, "redo"), cmd: "redo" }),
                (n = e).addButton("undo", { tooltip: "Undo", onPostRender: ji(n, "undo"), cmd: "undo" }),
                n.addButton("redo", { tooltip: "Redo", onPostRender: ji(n, "redo"), cmd: "redo" });
        },
        Gi = function (e) {
            var t, n;
            ...
            setup: function (e) {
                ...
                e.rtl && (st.rtl = !0),
                    ...
                    (t = e).settings.ui_container &&
                        (fe.container = Ri(vn.fromDom(_.document.body), t.settings.ui_container).fold(H(null), function (e) {
                            return e.dom();
                        })),
                    (Wt.tooltips = !fe.iOS),
                    (st.translate = function (e) {
            ...
            initLayoutRect: function () {
                ...
                return (
                    e.settings.multiline &&
                        (Re.getSize(e.getEl()).width > t.maxW && ((t.minW = t.maxW), e.classes.add("multiline")), (e.getEl().style.width = t.minW + "px"), (t.startMinH = t.h = t.minH = Math.min(t.maxH, Re.getSize(e.getEl()).height))),
                    t
                );
            },
            repaint: function () {
        ...
        ir = nr.extend({ Defaults: { role: "menubar", containerCls: "menubar", ariaRoot: !0, defaults: { type: "menubutton" } } }),
        rr = Gt.extend({
            init: function (e) {
                var t = this;
            ...
            showMenu: function (e) {
                ...
                n.menu ||
                    ...
                    t.renderTo ? (n.menu = t.parent(n).show().renderTo()) : (n.menu = b.create(t).parent(n).renderTo()),
                    n.fire("createmenu"),
                    n.menu.reflow(),
            ...
            renderHtml: function () {
                ...
                return (
                    ...
                    t.aria("role", t.parent() instanceof ir ? "menuitem" : "button"),
                    '<div id="' +
                        n +
                        '" class="' +
                        t.classes +
        ...
        or = kt.extend({
            ...
            load: function () {
                ...
                n.settings.itemsFactory &&
                    (n.throbber ||
                        ((n.throbber = new Tt(n.getEl("body"), !0)),
                        0 === n.items().length
                ...
                if (
                    ...
                    (t = n.menu)
                        ...
                        : ((t = e.menu).length ? (t = { type: "menu", items: t }) : (t.type = t.type || "menu"),
                          ...
                          (t = n.menu = b.create(t).parent(n).renderTo()).reflow(),
                    ...
                    l &&
                        (l = (function (e) {
                            var t,
                                n,
                                i = {};
                            for (i = fe.mac ? { alt: "&#x2325;", ctrl: "&#x2318;", shift: "&#x21E7;", meta: "&#x2318;" } : { meta: "Ctrl" }, e = e.split("+"), t = 0; t < e.length; t++) (n = i[e[t].toLowerCase()]) && (e[t] = n);
                            return e.join("+");
                        })(l)),
        ...
        lr = Qt.extend({ Defaults: { classes: "radio", role: "radio" } }),
        ur = Wt.extend({
            renderHtml: function () {
                var e = this,
                    t = e.classPrefix;
            ...
            postRender: function () {
                var t = this;
                t._super(),
                    (t.resizeDragHelper = new ft(this._id, {
                        start: function () {
                            t.fire("ResizeStart");
                        },
                        drag: function (e) {
    ...
    var dr = Wt.extend({
        ...
        renderHtml: function () {
            var e,
                t = this,
                n = "";
            return (e = cr(t._options)), t.size && (n = ' size = "' + t.size + '"'), '<select id="' + t._id + '" class="' + t.classes + '"' + n + ">" + e + "</select>";
        },
        bindStates: function () {
            var t = this;
            return (
                t.state.on("change:options", function (e) {
                    t.getEl().innerHTML = cr(e.value);
                }),
                t._super()
            );
        },
    ...
    function mr(e, t) {
        ...
        "v" === e.settings.orientation ? ((r = "top"), (i = "height"), (n = "h")) : ((r = "left"), (i = "width"), (n = "w")),
            (s = e.getEl("handle")),
            (o = ((e.layoutRect()[n] || 100) - Re.getSize(s)[i]) * ((t - e._minValue) / (e._maxValue - e._minValue)) + "px"),
            (s.style[r] = o),
            (s.style.height = e.layoutRect().h + "px"),
            hr(s, "valuenow", t),
            hr(s, "valuetext", "" + e.settings.previewFilter(t)),
            hr(s, "valuemin", e._minValue),
            hr(s, "valuemax", e._maxValue);
    }
    var gr = Wt.extend({
            init: function (e) {
                var t = this;
                e.previewFilter ||
                    ...
                    (t._minValue = X(e.minValue) ? e.minValue : 0),
                    (t._maxValue = X(e.maxValue) ? e.maxValue : 100),
            ...
            postRender: function () {
                ...
                (e = m._minValue),
                    ...
                    (function (o, s) {
                        function t(e) {
                            var t, n, i, r;
                            (t = fr((t = (((t = m.value()) + (r = n = o)) / ((i = s) - r) + 0.05 * e) * (i - n) - n), o, s)), m.value(t), m.fire("dragstart", { value: t }), m.fire("drag", { value: t }), m.fire("dragend", { value: t });
                        }
                    ...
                    (a = t),
                    (l = m.getEl("handle")),
                    (m._dragHelper = new ft(m._id, {
                        handle: m._id + "-handle",
                        start: function (e) {
                            (u = e[n]), (c = parseInt(m.getEl("handle").style[i], 10)), (d = (m.layoutRect()[o] || 100) - Re.getSize(l)[r]), m.fire("dragstart", { value: h });
                        },
                        drag: function (e) {
                            var t = e[n] - u;
                            (f = fr(c + t, 0, d)),
            ...
            repaint: function () {
                this._super(), mr(this, this.value());
            },
            bindStates: function () {
                var t = this;
                return (
        ...
        vr = rr.extend({
            ...
            repaint: function () {
                var e,
                    ...
                    n = this.getEl(),
                    i = this.layoutRect();
                return this._super(), (e = n.firstChild), (t = n.lastChild), we(e).css({ width: i.w - Re.getSize(t).width, height: i.h - 2 }), we(t).css({ height: i.h - 2 }), this;
            },
            activeMenu: function (e) {
        ...
        yr = bt.extend({
            ...
            activateTab: function (n) {
                var e;
                this.activeTabId && ((e = this.getEl(this.activeTabId)), we(e).removeClass(this.classPrefix + "active"), e.setAttribute("aria-selected", "false")),
                    (this.activeTabId = "t" + n),
                    (e = this.getEl("t" + n)).setAttribute("aria-selected", "true"),
                    we(e).addClass(this.classPrefix + "active"),
            ...
            initLayoutRect: function () {
                var e,
                    ...
                    n,
                    i = this;
                (t = (t = Re.getSize(i.getEl("head")).width) < 0 ? 0 : t),
                    (n = 0),
                    i.items().each(function (e) {
                ...
                var r = Re.getSize(i.getEl("head")).height;
        ...
        xr = Wt.extend({
            ...
            renderHtml: function () {
                ...
                return (
                    ...
                    ((e = Re.create(i.multiline ? "textarea" : "input", t)).value = n.state.get("value")),
    ...
    w.each(wr(), function (e, t) {
        ...
        _r(window.tinymce ? window.tinymce : {}),
        o.add("modern", function (e) {
            return Ki.setup(e), Xt(e);
        });
})(window);
