    ...
    <aside class="side-nav" id="show-side-navigation1">
      ...
      <ul class="categories mt-3">
        ...
        <li title="Date of Birth" class="date_of_birth">
          <img width="25px" src="{{url('/')}}/images/birthday.png" />&nbsp;&nbsp; {{date("m/d/Y", strtotime($affiliate->clientDetails->dob))}}&nbsp;&nbsp; <img src="{{url('/')}}/images/age.jpg" width="25px" />&nbsp;&nbsp; {{date("Y")-
          date("Y",strtotime($affiliate->clientDetails->dob))}}
        </li>
