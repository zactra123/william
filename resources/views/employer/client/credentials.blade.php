  ...
  <div class="container">
    <div class="card w-75">
      <div class="card-body w-100">
        {!! Form::open(['route' => ["adminRec.credentialsUpdate", $client->id], 'method' => 'POST', 'class' => 'm-form m-form--label-align-right', 'id'=>'client-credentials']) !!} @method("put") @csrf @if(empty($source) || $source ==
        'credit_karma')
        <div class="col-sm-12">
        ...
        @endif @if(empty($source) || $source == 'experian')
        <div class="col-sm-12">
          <label>
            <img class="report_access" src="{{asset('images/report_access/ex_logo_1.png')}}" width="200" /> If You are Not Register
            <a href="https://usa.experian.com/#/registration?offer=at_fcras100&br=exp&dAuth=true" target="_blank">Click here to register</a>
          </label>
          <div class="form-group m-1 font">
        ...
        @endif @if(empty($source) || $source == 'transunion_member')
        <div class="col-sm-12">
          <label>
            <img class="report_access" src="{{asset('images/report_access/tu_logo_1.png')}}" width="200" /> If You are Not Register
            <a href="https://membership.tui.transunion.com/tucm/orderStep1_form.page?offer=3BM10246&PLACE_CTA=top_right_search" target="_blank">Click here to register</a>
          </label>
          <div class="form-group m-1 font">
        ...
        @endif @if(empty($source) || $source == 'transunion_dispute')
        <div class="col-sm-12">
          <label>
        ...
        @endif @if(empty($source) || $source == 'equifax')
        <div class="col-sm-12">
          <label>
            <img class="report_access" src="{{asset('images/report_access/eq_logo_1.png')}}" width="200" /> If You are Not Register
            <a href="https://my.equifax.com/consumer-registration/UCSC/#/personal-info" target="_blank">Click here to register</a>
          </label>
          <div class="form-group m-1 font">
