						...
						<div class="modal-body">
							...
							<form method="post" action="{{route('admin.appointment.create')}}">
								...
								<div class="full_name_id m-1">
									<input type="text" name="full_name" id="fullNameId" placeholder="{{ zactra::translate_lang('FULL NAME') }}">
								</div>
								<div class="phone_number_id m-1">
									<input type="text" name="phone_number" id="phoneNumberId" placeholder="{{ zactra::translate_lang('PHONE NUMBER') }}">
								</div>
								<div class="email_id m-1">
									<input type="email" name="email" id="emailId" placeholder="{{ zactra::translate_lang('EMAIL') }}">
								</div>
								<div class="time_id m-1">
									<input type="time" name="time" id="timeId" placeholder="{{ zactra::translate_lang('TIME') }}">
								</div>
								<div class="title_id m-1">
									<input type="text" name="title" id="titleId" placeholder="{{ zactra::translate_lang('TITLE') }}">
								</div>
								<div class="form-group row m-1">
									<textarea name="description" id="descriptionId" placeholder="{{ zactra::translate_lang('DESCRIPTION') }}"> </textarea>
								</div>
								<div class="form-group row mb-0">
									<div class="col-md-9 offset-md-5">
										<button type="submit" class="btn btn-primary">
											{{ zactra::translate_lang('ADD MESSAGE') }}
										</button>
									</div>
								</div>
							</form>
			...
			<div class="modal fad" id="appointmentDetails" tabindex="-1" role="dialog" aria-labelledby="appointmentDetailsModalLabel">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div><span class="text-primary pr-1 pb-3">{{ zactra::translate_lang('FULL NAME') }}</span><span id="appointment-full_name"></span></div>
							<div><span class="text-primary pr-1 pb-3"><i class="fa fa-mobile-phone pr-1"></i>{{ zactra::translate_lang('Phone Number:') }}</span><span id="appointment-phone"></span></div>
							<div><span class="text-primary pr-1 pb-3">{{ zactra::translate_lang('EMAIL:') }}</span><span id="appointment-email"></span></div>
							<div><span class="text-primary pr-1 pb-3"><i class="fa fa-calendar pr-1"></i>{{ zactra::translate_lang('Date:') }}</span><span id="appointment-date"></span></div>
							...
							<div class="addNote" style="display: none;">
								<form method="POST" action="{{ route('admin.message.note') }}">
									...
									<div class="form-group row mb-0">
										<div class="col-md-9 offset-md-5">
											<button type="submit" class="btn btn-primary">{{ zactra::translate_lang('Add') }}</button>
										</div>
									</div>
								</form>
							</div>
						...
						<div class="modal-footer">
							...
							<button class="btn btn-primary add-note">{{ zactra::translate_lang('ADD NOTE') }}</button>
						</div>
						<div class="modal-footer">
					...
					<div class="modal-content">
						...
						<div class="modal-body ">
							<form method="PUT" action="" id="updateMessageId">
								...
								<div class="full_name_id m-1">
									<input type="text" name="full_name" id="oldFullNameId" placeholder="{{ zactra::translate_lang('FULL NAME') }}">
								</div>
								<input type="hidden" name="id" id="editMessageId">
								<div class="phone_number_id m-1">
									<input type="text" name="phone_number" id="oldPhoneNumberId" placeholder="{{ zactra::translate_lang('PHONE NUMBER') }}">
								</div>
								<div class="email_id m-1">
									<input type="email" name="email" id="oldEmailId" placeholder="{{ zactra::translate_lang('EMAIL') }}">
								</div>
								<div class="time_id m-1">
									<input type="date" name="date" id="oldDateId" placeholder="{{ zactra::translate_lang('Date') }}">
								</div>
								<div class="time_id m-1">
									<input type="time" name="time" id="oldTimeId" placeholder="{{ zactra::translate_lang('TIME') }}">
								</div>
								<div class="title_id m-1">
									<input type="text" name="title" id="oldTitleId" placeholder="{{ zactra::translate_lang('TITLE') }}">
								</div>
								<div class="form-group row m-1">
									<textarea name="description" id="oldDescriptionId" placeholder="{{ zactra::translate_lang('DESCRIPTION') }}"> </textarea>
								</div>
								<div class="form-group row mb-0">
									<div class="col-md-9 offset-md-5">
										<button type="submit" class="btn btn-primary">
											{{ zactra::translate_lang('EDIT MESSAGE') }}
										</button>
									</div>
								</div>
							</form>
