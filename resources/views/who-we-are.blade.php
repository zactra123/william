			...
			<div class="row">
				...
				<div class="col-md-6 mb-5">
					...
					<p class="who-font text-justify">
						{{ zactra::translate_lang('At Prudent Credit Solutions, we have over eighteen years of experience in the credit repair industry.
					...
					<p class="who-font text-justify">
						{{ zactra::translate_lang('We know the stress that bankruptcies, foreclosures, and other financial hardship can create – and we
					...
					<p class="who-font text-justify">
						{{ zactra::translate_lang('Most of the other credit repair firms are in letter writing business. Writing dispute letters is a
