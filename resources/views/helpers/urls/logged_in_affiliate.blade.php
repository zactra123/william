<li class="dropdown menu-item sign-hide" ><a href="#" onclick="location.href='{{ url('/affiliate') }}'" class="dropdown-toggle" data-toggle="dropdown"><img src="{{asset('images/user.png')}}" alt="">{{ Auth::user()->email }}<span class="caret"></span></a>
