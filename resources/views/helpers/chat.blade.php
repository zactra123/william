            ...
            <div class="body"  id="chat_body">
                <div class="not-defined-user">
                    ...
                    <form action="" id="chat_form">
                        @csrf
                        <input type="text" name="full_name" value="" placeholder="Your full name" autofocus>
                        <div class="contact">
                            <label for="email" class="email-label">
                                <input type="email" name="email" value="" id="email" placeholder="E-mail Address">
                            </label>
                            <p>or</p>
                            <label for="phone" class="phone-label">
                                <input type="tel" id="phone" name="phone" class="us-phone" disabled placeholder="Phone Number">
                            </label>
                        </div>
                        <div class="textarea">
                ...
                <div class="defined-user" >
                    ...
                    <div class="chat-box">
                        <div class="chat-box-inner chat-content">
                    ...
                    <form action="" id="chat_form">
                        <div class="textarea">
                            <textarea class=" form-control textinput" placeholder="Type message..." name="message" cols="30" rows="10"></textarea>
                        </div>
                        <div class="form-submit">
...
{{--                </p>--}}
{{--            </div>--}}
{{--            <div class="body active" id="chat_body">--}}
{{--                <div class="chat-title">--}}
{{--                    <h3>Chat</h3>--}}
{{--                    <div id="chat_close">--}}
{{--                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
...
{{--                            <p class="message">--}}
{{--                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi nulla cum vel mollitia.--}}
{{--                            </p>--}}
{{--                            <p class="time">--}}
{{--                                11:30--}}
{{--                            </p>--}}
...
{{--                <form action="" id="chat_form">--}}
{{--                    <div class="textarea">--}}
{{--                        <textarea placeholder="Type message..." cols="30" rows="10"></textarea>--}}
{{--                    </div>--}}
{{--                    <div class="form-submit">--}}
{{--                        <input type="submit" value="Send">--}}
{{--                    </div>--}}
