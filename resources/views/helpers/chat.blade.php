...
<div class="chat" id="chat">
    ...
    <svg width="368" viewBox="0 0 368 52" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            d="M26 22.5049C19.6 42.9049 6 50.0049 0 51.0049H368C352 49.5049 342 21.0049 341.5 21.5049C333.1 3.90485 315 -0.161814 307 0.00485253C223 0.171519 55 0.404853 55 0.00485253C37.4 0.404853 28.3333 15.1715 26 22.5049Z"
...
<div class="body" id="chat_body">
    <div class="not-defined-user">
        ...
        <form action="" id="chat_form">
            @csrf
            <input type="text" name="full_name" value="" class="form-control" placeholder="Your full name" autofocus />
            <div class="contact">
                <label for="email" class="email-label">
                    <input type="email" name="email" value="" id="email" class="form-control" placeholder="E-mail Address" />
                </label>
                <p class="text-white">or</p>
                <label for="phone" class="phone-label">
                    <input type="tel" id="phone" name="phone" class="us-phone form-control" disabled placeholder="Phone Number" />
                </label>
            </div>
            <div class="textarea">
                <textarea name="message" placeholder="Write your message" class="form-control" cols="30" rows="10"></textarea>
            </div>
    ...
    <div class="defined-user">
        ...
        <form action="" id="chat_form">
            ...
            <div class="form-submit mb-5 text-right">
                <input type="submit" class="float-right" value="Send" />
            </div>
        </form>
    </div>
</div>
