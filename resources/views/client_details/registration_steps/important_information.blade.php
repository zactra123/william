...
<div class="col-md-12 col-lg-12 col-sm-12 col-12">
	<label for="" class="theme-color-dark fs-14">{{ zactra::translate_lang('Personal Information') }}</label>
	<div class="row">
		...
		<div class="col-md-6 col-lg-6 col-sm-12 col-12">
			<input id="phone_number" type="text" name="phone_number" value="{{ !empty(old('phone_number')) ? old('phone_number') : (!empty($client->clientDetails) ? $client->clientDetails->phone_number: "") }}" required autocomplete="phone_number" placeholder="{{ zactra::translate_lang('Phone Number') }}">
		</div>
	</div>
	<div class="row">
		<div class="col-md-12 col-lg-12 col-sm-12 col-12">
			<label for="" class="theme-color-dark fs-14">{{ zactra::translate_lang('Gender') }}</label>
			<div class="select">
	...
	<label for="" class="theme-color-dark fs-14">{{ zactra::translate_lang('Security Question') }}</label>
	<div class="row">
		<div class="col-md-6 col-lg-6 col-sm-12 col-12">
			<div class="select">
			...
			<div class="none w-100" id="custom-secret-question">
				<input name="own_secter_question" type="text" class="" placeholder="{{ zactra::translate_lang('Own question') }}">
			</div>
		</div>
		<div class="col-md-6 col-lg-6 col-sm-12 col-12">
			<input id="secret_answer" type="text" class="" name="secret_answer" value="{{ old('secret_answer') }}" placeholder="{{ zactra::translate_lang('Please answer in secret question') }}">
		</div>
	</div>
...
<div class="col-md-12 text-center">
	<div class="basic-button">
		<input class="login" type="submit" value="{{ zactra::translate_lang('Continue') }}" name="">
	</div>
</div>
{!! Form::close() !!}
