				...
				<div class="col-md-10 mt20">
					<div class="chart-report">
						<div class="row mt20">
							...
							<div class="col-md-2">
								<span style="font-weight: bold; font-size: 16px;">{{ zactra::translate_lang('DISPUTE') }}</span>
							</div>
						</div>
						...
						<div class="row mt20 border">
							...
							<div class="col-md-2">
								<div class="col-md-6">
									<label class="form-text">{{ zactra::translate_lang('DISPUTE') }}</label>
								</div>
								<div class="col-md-4">
					...
					<div class="chart-report">
						...
						<div class="row mt20 border">
							...
							<div class="col-md-4 border">
								{{ zactra::translate_lang('LATE') }} {{$payment->status}} {{ zactra::translate_lang('AS OF') }} {{$payment->month}}{{ zactra::translate_lang('/') }}{{$payment->year}}
							</div>
							@endforeach
						</div>
						@endif
					...
					<div class="mt20"></div <div class="chart-report">
			...
			<div class="col-md-10 mt20">
				...
				<div class="chart-report">
					...
					<div class="row mt20">
						...
						<div class="col-md-3">
							{{ zactra::translate_lang('LATE') }} {{$payment->value}} {{ zactra::translate_lang('AS OF') }} {{$payment->month}}{{ zactra::translate_lang('/') }}{{$payment->year}}
						</div>
						@endforeach
					</div>
					@endif
				...
				<div class="chart-report">
					...
					<div class="row border" style="font-weight: bold;">
						...
						<div class="col-md-7">
							<span class="">{{$accounts->account_name}}</span>
							<span style="padding-left: 15px;">{{ zactra::translate_lang('#') }} {{$accounts->account_number}}</span>
						</div>
						@if(!empty($accounts->dispute->id))
						<div class="col-md-2">
							<div class="col-md-12">
