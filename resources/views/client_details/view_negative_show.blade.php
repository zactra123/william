		...
		<div class="Experian" style="display: block;">
					...
					<div class="chart-report">
						<div class="row">
							...
							<div class="col-md-6" style="font-weight: bold;">
								<span style="font-weight: bold; font-size: 16px;">{{ zactra::translate_lang('PHONE #') }} </span>
							</div>
					...
					<div class="chart-report title-ex_public-{{$ex_public->id}}">
						<div class="row" style="font-weight: bold;">
							...
							<div class="col-md-2 delete-name" data-attribute="title-ex_public-{{$ex_public->id}}">
								<span style="font-weight: bold; font-size: 16px;">{{ zactra::translate_lang('DESELECT') }}</span> <i class="fa fa-check-square-o" aria-hidden="true" style="margin-left: 30%;"></i>
          ...
          @if(strpos($string, "LATE")!==false && strpos($string, "OPEN")!==false)
							...
							<div class="row mt20">
								<div class="col-md-12">
									<div class="col-md-6">
										...
										<input class="form-control" type="text" name="ex_account[{{$ex_account->id}}][account_number]" placeholder="{{ zactra::translate_lang('FULL ACCOUNT NUMBER') }}" />
									</div>
									<div class="col-md-6">
										<input class="form-control" type="text" name="ex_account[{{$ex_account->id}}][expiration_date]" placeholder="{{ zactra::translate_lang('EXPIRATION DATE') }}" />
									</div>
								</div>
							</div>
							<div class="row mt20">
								<div class="col-md-12">
									<div class="col-md-6">
										<input class="form-control" type="text" name="ex_account[{{$ex_account->id}}][cvc]" placeholder="{{ zactra::translate_lang('CVC (CARD VERIFICATION CODE)') }}" />
									</div>
									<div class="col-md-6">
										<input class="form-control" type="text" name="ex_account[{{$ex_account->id}}][security_word]" placeholder="{{ zactra::translate_lang('SECURITY WORD') }}" />
									</div>
								</div>
							</div>
							@endif
              @if(strpos(strtoupper($ex_account->type), "AUTO")!== false)
							...
							<div class="row mt-20">
								<div class="col-md-12">
									...
									<div class="col-md-4">
										<input class="form-control" type="text" name="ex_account[{{$ex_account->id}}][year]" placeholder="{{ zactra::translate_lang('YEAR') }}" />
									</div>
									<div class="col-md-4">
										<input class="form-control" type="text" name="ex_account[{{$ex_account->id}}][make]" placeholder="{{ zactra::translate_lang('MAKE') }}" />
									</div>
								</div>
							</div>
							<div class="row mt20">
								<div class="col-md-12">
									<div class="col-md-6">
										<input class="form-control" type="text" name="ex_account[{{$ex_account->id}}][model]" placeholder="{{ zactra::translate_lang('MODEL') }}" />
									</div>
									<div class="col-md-6">
										<input class="form-control" type="text" name="ex_account[{{$ex_account->id}}][security_word]" placeholder="{{ zactra::translate_lang('SECURITY WORD') }}" />
									</div>
              ...
              @if(strpos(strtoupper($ex_account->type), "PERSONAL")!== false)
							...
							<div class="row mt20">
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<input class="form-control" type="text" name="ex_account[{{$ex_account->id}}][account_number]" placeholder="{{ zactra::translate_lang('SECURITY WORD') }}" />
									</div>
								</div>
							</div>
							@endif
              @if(strpos(strtoupper($ex_account->type), "STUDENT")!== false)
							...
							<div class="col-md-3">
								<div class="col-md-12">
									...
									<input type="text" name="ex_account[{{$ex_account->id}}][account_number]" placeholder="{{ zactra::translate_lang('FULL ACCOUNT NUMBER') }}" />
								</div>
							</div>
							<div class="col-md-3">
								<div class="col-md-12">
									<input type="text" name="ex_account[{{$ex_account->id}}][school_attened]" placeholder="{{ zactra::translate_lang('SCHOOL ATTENDED') }}" />
								</div>
							</div>
							<div class="col-md-3">
								<div class="col-md-12">
									<input type="text" name="ex_account[{{$ex_account->id}}][security_word]" placeholder="{{ zactra::translate_lang('SECURITY WORD') }}" />
								</div>
							</div>
							@endif
              @if(strpos(strtoupper($ex_account->type), "MORTGAGE")!== false)
							...
							<div class="col-md-3">
								<div class="col-md-12">
									<input type="text" name="ex_account[{{$ex_account->id}}][propety_address]" placeholder="{{ zactra::translate_lang('PROPERTY ADDRESS') }}" />
								</div>
							</div>
							<div class="col-md-3">
								<div class="col-md-12">
					...
					<div class="chart-report title-tu_account-{{$tu_account->id}}">
						<div class="row mt20" style="font-weight: bold;">
							...
							<div class="col-md-6">
								...
								<span style="padding-left: 15px;"> {{ zactra::translate_lang('#') }} {{$tu_account->account_number}}</span>
							</div>
						...
						<div class="row mt20 border" style="font-weight: bold;">
							...
							<div class="row mt20">
								<div class="col-md-12">
									<div class="col-md-6">
										...
										<input class="form-control" type="text" name="tu_account[{{$tu_account->id}}][account_number]" placeholder="{{ zactra::translate_lang('FULL ACCOUNT NUMBER') }}" />
									</div>
									<div class="col-md-6">
										<input class="form-control" type="text" name="tu_account[{{$tu_account->id}}][expiration_date]" placeholder="{{ zactra::translate_lang('EXPIRATION DATE') }}" />
									</div>
								</div>
							</div>
							<div class="row mt20">
								<div class="col-md-12">
									<div class="col-md-6">
										<input class="form-control" type="text" name="tu_account[{{$tu_account->id}}][cvc]" placeholder="{{ zactra::translate_lang('CVC (CARD VERIFICATION CODE)') }}" />
									</div>
									<div class="col-md-3">
										<input class="form-control" type="text" name="tu_account[{{$tu_account->id}}][security_word]" placeholder="{{ zactra::translate_lang('SECURITY WORD') }}" />
									</div>
								</div>
							</div>
							@endif
							...
							<div class="row mt-20">
								<div class="col-md-12">
									...
									<div class="col-md-4">
										<input class="form-control" type="text" name="tu_account[{{$tu_account->id}}][year]" placeholder="{{ zactra::translate_lang('YEAR') }}" />
									</div>
									<div class="col-md-4">
										<input class="form-control" type="text" name="tu_account[{{$tu_account->id}}][make]" placeholder="{{ zactra::translate_lang('MAKE') }}" />
									</div>
								</div>
							</div>
							<div class="row mt20">
								<div class="col-md-12">
									<div class="col-md-6">
										<input class="form-control" type="text" name="tu_account[{{$tu_account->id}}][model]" placeholder="{{ zactra::translate_lang('MODEL') }}" />
									</div>
									<div class="col-md-6">
										<input class="form-control" type="text" name="tu_account[{{$tu_account->id}}][security_word]" placeholder="{{ zactra::translate_lang('SECURITY WORD') }}" />
									</div>
							...
							<div class="col-md-3">
								<div class="col-md-12">
									...
									<input type="text" name="tu_account[{{$tu_account->id}}][account_number]" placeholder="{{ zactra::translate_lang('FULL ACCOUNT NUMBER') }}" />
								</div>
							</div>
							<div class="col-md-3">
								<div class="col-md-12">
									<input type="text" name="tu_account[{{$tu_account->id}}][school_attended]" placeholder="{{ zactra::translate_lang('SCHOOL ATTENDED') }}" />
								</div>
							</div>
							<div class="col-md-3">
								<div class="col-md-12">
									<input type="text" name="tu_account[{{$tu_account->id}}][security_word]" placeholder="{{ zactra::translate_lang('SECURITY WORD') }}" />
								</div>
							</div>
							@endif
							...
							<div class="col-md-3">
								<div class="col-md-12">
									...
									<input type="text" name="tu_account[{{$tu_account->id}}][school_attended]" placeholder="{{ zactra::translate_lang('FULL ACCOUNT NUMBER') }}" />
								</div>
							</div>
							<div class="col-md-3">
								<div class="col-md-12">
									<input type="text" name="tu_account[{{$tu_account->id}}][property_address]" placeholder="{{ zactra::translate_lang('PROPERTY ADDRESS') }}" />
								</div>
							</div>
							<div class="col-md-3">
								<div class="col-md-12">
						...
						<div class="row mt20 border" style="font-weight: bold;">
							...
							<div class="row mt20">
								<div class="col-md-12">
									<div class="col-md-6">
										...
										<input class="form-control" type="text" name="eq_account[{{$eq_account->id}}][account_number]" placeholder="{{ zactra::translate_lang('FULL ACCOUNT NUMBER') }}" />
									</div>
									<div class="col-md-6">
										<input class="form-control" type="text" name="eq_account[{{$eq_account->id}}][eqpiration_date]" placeholder="{{ zactra::translate_lang('EXPIRATION DATE') }}" />
									</div>
								</div>
							</div>
							<div class="row mt20">
								<div class="col-md-12">
									<div class="col-md-6">
										<input class="form-control" type="text" name="eq_account[{{$eq_account->id}}][cvc]" placeholder="{{ zactra::translate_lang('CVC (CARD VERIFICATION CODE)') }}" />
									</div>
									<div class="col-md-6">
										<input class="form-control" type="text" name="eq_account[{{$eq_account->id}}][security_word]" placeholder="{{ zactra::translate_lang('SECURITY WORD') }}" />
									</div>
								</div>
							</div>
							@endif
							...
							<div class="row mt-20">
								<div class="col-md-12">
									...
									<div class="col-md-4">
										<input class="form-control" type="text" name="eq_account[{{$eq_account->id}}][year]" placeholder="{{ zactra::translate_lang('YEAR') }}" />
									</div>
									<div class="col-md-4">
										<input class="form-control" type="text" name="eq_account[{{$eq_account->id}}][make]" placeholder="{{ zactra::translate_lang('MAKE') }}" />
									</div>
								</div>
							</div>
							<div class="row mt20">
								<div class="col-md-12">
									<div class="col-md-6">
										<input class="form-control" type="text" name="eq_account[{{$eq_account->id}}][model]" placeholder="{{ zactra::translate_lang('MODEL') }}" />
									</div>
									<div class="col-md-6">
										<input class="form-control" type="text" name="eq_account[{{$eq_account->id}}][security_word]" placeholder="{{ zactra::translate_lang('SECURITY WORD') }}" />
									</div>
							...
							<div class="row mt20">
								<div class="col-md-12">
									<div class="col-md-6">
										...
										<input class="form-control" type="text" name="eq_account[{{$eq_account->idd}}][account_number]" placeholder="{{ zactra::translate_lang('FULL ACCOUNT NUMBER') }}" />
									</div>
									<div class="col-md-3">
										<input class="form-control" type="text" name="eq_account[{{$eq_account->id}}][security_word]" placeholder="{{ zactra::translate_lang('SECURITY WORD') }}" />
									</div>
              ...
              @if(strpos(strtoupper($eq_account->category_type), "STUDENT")!== false)
							...
							<div class="col-md-3">
								<div class="col-md-12">
									...
									<input type="text" name="eq_account[{{$eq_account->id}}][account_number]" placeholder="{{ zactra::translate_lang('FULL ACCOUNT NUMBER') }}" />
								</div>
							</div>
							<div class="col-md-3">
								<div class="col-md-12">
									<input type="text" name="eq_account[{{$eq_account->id}}][Scholl_attended]" placeholder="{{ zactra::translate_lang('SCHOOL ATTENDED') }}" />
								</div>
							</div>
							<div class="col-md-3">
								<div class="col-md-12">
									<input type="text" name="eq_account[{{$eq_account->id}}][secutity_word]" placeholder="{{ zactra::translate_lang('SECURITY WORD') }}" />
								</div>
							</div>
							@endif
							...
							<div class="col-md-3">
								<div class="col-md-12">
									<input type="text" name="eq_account[{{$eq_account->id}}][property_address]" placeholder="{{ zactra::translate_lang('PROPERTY ADDRESS') }}" />
								</div>
							</div>
							<div class="col-md-3">
								<div class="col-md-12">
									<input type="text" name="eq_account[{{$eq_account->id}}][security_word]" placeholder="{{ zactra::translate_lang('SECURITY WORD') }}" />
								</div>
							</div>
							@endif
						</div>
