      ...
      <div class="col-md-12">
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            'NON-BANK SBA LENDER', 'BANK-SBA LENDER' => 'BANK-SBA LENDER']; asort($types)?> {!! Form::select("types[]", [""=>"FILTER BY TYPE"] + $types, request()->types, ['multiple'=>'multiple', 'class'=>'form-control mmb-5
