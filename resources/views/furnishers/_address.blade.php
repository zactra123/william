<formset class="additional_address">
  ...
  <div class="col-md-12 addresses">
    ...
    <div class="row">
      {!! Form::hidden("bank_address[$type][{$address->id}][type]", $type, ["class"=>"form-control"]) !!}
      {!! Form::hidden("bank_address[$type][{$address->id}][id]", !empty($address) ? $address['id'] : null, ["class"=>"form-control"]) !!}
