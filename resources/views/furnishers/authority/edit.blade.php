          ...
          <h4 class="content-title mb-2">Hi, welcome back!</h4>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Update Authority > {{ $authority->name }}</li>
              </ol>
            </nav>
      </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card mg-b-20" id="tabs-style2">
                    <div class="card-body">
                        ...
                        <p class="mg-b-20">See list of bank detail here ...</p>
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="album">
                                            <div class="container">
                                                ...
                                                <div class="row">
                                                    <?php $states = [null=>''] + \App\BankAddress::STATES;?> @method('PUT') @csrf
                                                    <div class="col-md-12">
                                                      <div class="row">
                                                        <div class="col-md-5">
                                                        ...
                                                        <div class="col-md-6 mb-4 changeLogo files">
                                                            ...
                                                            @if (isset($authority->path))
                                                                 ...
                                                                 @if (file_exists($findfile))
                                                                   ...
                                                                   @else
                                                                     <a href="{{route("admins.authority.edit", $authority->id)}}"><img class="card-img-top banks-card" src="{{asset('images/default_bank_logos.png')}}" style="width:150px;" alt="Card image cap"></a>
                                                                   @endif
                                                                 @else
                                                                       <a href="{{route("admins.authority.edit", $authority->id)}}"><img class="card-img-top banks-card" src="{{asset('images/default_bank_logos.png')}}" style="width:150px;" alt="Card image cap"></a>
                                                                   @endif
