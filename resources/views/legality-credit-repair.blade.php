		...
		<div class="section-title text-center">
			...
			<div class="wrapper-content mt-5">
				...
				<p class="text-justify fs-18 mt-4">
					{{ zactra::translate_lang('Credit repair may not have the best reputation as financial services go, but it is a
				...
				<p class="text-justify fs-18 mt-3">
					{{ zactra::translate_lang('It is important to note that credit repair is legal in all 50 states. There is a federal
					law that guarantees consumers the right to dispute information in their credit report to
					have it corrected. There is also a federal law that outlines how credit repair companies
