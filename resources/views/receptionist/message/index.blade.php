...
<div class="breadcrumb-header justify-content-between">
	<div>
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="{{ url('/receptionist') }}">{{ zactra::translate_lang('Dashboard') }}</a></li>
										...
										<div class="modal-body">
											<table class="table table-striped">
												...
												<tr>
													...
													<td>
														<p id="appointment-title" class="appointment-title"></p>
													</td>
												</tr>
												<tr>
													<th>{{ zactra::translate_lang('DESCRIPTION:') }}</th>
													<td>
														<p class="appointment-desc" id="appointment-description"></p>
													</td>
												</tr>
											</table>
