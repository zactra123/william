...
<aside class="main-sidebar app-sidebar sidebar-scroll">
  ...
  <div class="sidebar-navs">
    <ul class="nav nav-pills-circle">
      <li class="nav-item" data-toggle="tooltip" data-placement="top" title="" data-original-title="{{ zactra::translate_lang('Reports') }}" aria-describedby="tooltip365540">
        <a class="nav-link text-center m-2" href="{{ route('owner.reports.index')}}"><i class="las la-poll"></i> </a>
      </li>
  ...
  <div class="main-sidebar-body">
    @if(Auth::user()) @if(Auth::user()->role == 'client')
    <ul class="side-menu">
      <li class="slide">
    ...
    @elseif(Auth::user()->role == 'affiliate') @include('helpers.urls.nav_bar_affiliate') @elseif(Auth::user()->role == 'super admin')
    <ul class="side-menu">
      <li class="slide">
      ...
      <li class="slide">
        <a class="side-menu__item  {{ zactra::areActiveRoute(['owner.credit.education.index','owner.credit.education.edit','owner.credit.education.create','owner.credit.education.show'])}}" href="{{route('owner.credit.education.index')}}">
          <i class="side-menu__icon fa fa-graduation-cap"></i><span class="side-menu__label">{{ zactra::translate_lang('Educations') }}</span>
        </a>
      </li>
      <li class="slide {{ zactra::areActiveDropdown(['admins.authority','admins.authority.create','admins.authority.edit','admins.bank','admins.bank.edit','admins.bank.create','admins.court.create','admins.court.edit'])}}">
        <a class="side-menu__item" data-toggle="slide" href="{{ route('admins.bank.show')}}">
          <i class="side-menu__icon ti-wallet"></i><span class="side-menu__label">{{ zactra::translate_lang('Furnishers/CRAs') }}</span><i class="angle fe fe-chevron-down"></i>
        </a>
        <ul class="slide-menu">
      ...
      <li class="slide">
        <a class="side-menu__item {{ zactra::areActiveRoute(['owner.translation.index','owner.translation.create','owner.translation.edit']) }}" href="{{ route('owner.translation.index') }}">
          <i class="side-menu__icon fa fa-language"></i><span class="side-menu__label">{{ zactra::translate_lang('Translation') }}</span>
        </a>
      </li>
      <li class="slide">
    ...
    <ul class="side-menu">
      ...
      <li class="slide">
        <a class="side-menu__item {{ zactra::areActiveRoute(['adminRec.client.profile']) }}" href="{{ route('adminRec.client.list')}}">
          <i class="side-menu__icon fe fe-user"></i><span class="side-menu__label">{{ zactra::translate_lang('Client List') }}</span>
        </a>
      </li>
      <li class="slide">
      ...
      <li class="slide">
        <a class="side-menu__item {{ zactra::areActiveRoute(['blog.create','blog.edit']) }}" href="{{ route('blog.index') }}">
          <i class="side-menu__icon las la-poll"></i><span class="side-menu__label">{{ zactra::translate_lang('Blog') }}</span>
        </a>
      </li>
      <li class="slide">
        <a class="side-menu__item" href="{{ route('owner.setting.index') }}"><i class="side-menu__icon icon-settings icons"></i><span class="side-menu__label">{{ zactra::translate_lang('Profile Settings') }}</span></a>
    ...
    <ul class="side-menu">
      ...
      <li class="slide">
        <a class="side-menu__item" href="{{ route('receptionist.liveChat.index')}}">
          <i class="side-menu__icon fa fa-envelope"></i><span class="side-menu__label">{{ zactra::translate_lang('Chat') }}</span>
