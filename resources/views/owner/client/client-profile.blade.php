...
@section('content')
    ...
    @include('helpers.breadcrumbs', ['title'=> "CLIENTS", 'route' => ["Home"=> '/owner',"CLIENTS PROFILE" => "#"]])
                                ...
                                <div class="card" >
                                    <div class="card-body" id="print-details">
                                        ...
                                        <div class="report_number " id="report_number">
                                            ...
                                            <div class="pb-1 row border-bottom">
                                                <input class="col-lg-4 client report internal"  name="ex_number" id="ex" value="" type="text" data-target="EX# " placeholder="EX# ************" >
                                                <input class="col-lg-4 client  report internal"  name="eq_number" id="eq" value="" type="text" data-target="EQ# " placeholder="EQ# ************" >
                                                <input class="col-lg-4 client   report external"  name="tu_number" id="tu" value="" type="text" data-target="TU# "placeholder="TU# ************" >
                                            </div>
                                            <div class="pb-1 row border-bottom">
                                                <input class="col-lg-4  client report  internal"  name="ftc_number" id="ftc"  value="" type="text" data-target="FTC# " placeholder="FTC# ************">
                                                <input class="col-lg-4  client  report external" name="dr_number" id="dr" value="" type="text" data-target="DR# " placeholder="DR# ************" >
                                            </div>
                                        </div>
                                        ...
                                        @else
                                            <div class="pb-1 pt-2 row  mr-0 ml-0 external border-bottom">
                                                ...
                                                <div class="col-lg-10 ">
                                                    <div class="row">
                                                        <label class="col-lg-4 m-0 p-0">  MALE
                                                            <input type="radio" name="sex" class="sex" value="M">
                                                        </label>
                                                        <label class="col-lg-4 m-0 p-0">  FEMALE
                                                            <input type="radio" name="sex" class="sex" value="F">
                                                        </label>
                                                        <label class="col-lg-2 m-0 p-0">  OTHER
                                                            <input type="radio" name="sex" class="sex" value="F">
                                                        </label>
