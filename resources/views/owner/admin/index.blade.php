  ...
  <div class="col-xl-12">
    <div class="card">
      <div class="card-header pb-0">
        ...
        <p class="tx-12 text-muted mb-2">{{ zactra::translate_lang('List of all admins for your system') }} <a href="{{ route('owner.admin.create')}}" class="btn btn-primary btn-sm float-right">{{ zactra::translate_lang('Create New Admin') }}</a></p>
      </div>
      <div class="card-body">
