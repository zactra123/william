  ...
  <div>
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">{{ zactra::translate_lang('Reset Password') }}</li>
      </ol>
    </nav>
  </div>
</div>
      ...
      <div class="card">
        <div class="card-body">
          <a href="{{ route('owner.admin.index') }}">
            <h5 class="text-dark"><i class="ti-angle-left"></i>{{ zactra::translate_lang('Reset Password') }}</h5>
          </a>
          <br />
          ...
          <div class="row">
            <div class="col-md-12">
              <input type="submit" class="btn btn-primary btn-block" value="{{ zactra::translate_lang('Change Password') }}" class="ms-ua-submit" />
            </div>
          </div>
          {!! Form::close() !!}
        </div>
