	        ...
	        <div class="pl-0">
	          <div class="main-profile-overview">
	            <div class="main-img-user profile-user">
	              ...
	              @endif
	              <a href="JavaScript:void(0);" onclick="getClickToFile('.profileimg')" class="fas fa-camera profile-edit"></a>
	            </div>
	            ...
	            <div class="main-profile-bio">{{ zactra::limit_words(Auth::user()->bio,150) }} <a href="javascript:void(0)" data-toggle="modal" data-target="#exampleModalCenter">{{ zactra::translate_lang('More') }}</a></div>
	            ...
	            <div class="main-profile-work-list">
	              <div class="media">
	                ...
	                <div class="media-body">
	                  <h6>Web Designer at <a href="#">Spruko</a></h6>
	              ...
	              <div class="media">
	                ...
	                <div class="media-body">
	                  <h6>Studied at <a href="#">University</a></h6>
	                  <span>2004-2008</span>
	            ...
	            <div class="main-profile-social-list">
	              <div class="media">
	                ...
	                <div class="media-body"><span>{{ zactra::translate_lang('Twitter') }}</span> <a href="{{ Auth::user()->twitter }}">{{ Auth::user()->twitter }}</a></div>
	              </div>
	              <div class="media">
	                <div class="media-icon bg-info-transparent text-info">
	                  <i class="icon ion-logo-linkedin"></i>
	                </div>
	                <div class="media-body"><span>{{ zactra::translate_lang('Linkedin') }}</span> <a href="{{ Auth::user()->linkedin }}">{{ Auth::user()->linkedin }}</a></div>
	              </div>
	              <div class="media">
	                <div class="media-icon bg-danger-transparent text-danger">
	                  <i class="icon ion-logo-googleplus"></i>
	                </div>
	                <div class="media-body"><span>{{ zactra::translate_lang('Google+') }}</span> <a href="{{ Auth::user()->googleplus }}">{{ Auth::user()->googleplus }}</a></div>
	              </div>
	            </div>
