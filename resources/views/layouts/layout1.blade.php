        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <p style="text-align: justify;">
              {{ zactra::translate_lang('We are always looking to partner with independent sales representatives. To inquire, please email your CV/resume to<a href="mailto:partners@prudentscores.com"> partners@prudentscores.com</a> and one
              of our representatives will contact you promptly.') }}
            </p>
          </div>
        </div>
      </div>
