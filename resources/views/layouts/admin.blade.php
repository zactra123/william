                        ...
                        <div class="col-12 pull-right signup">
                            <div class="pull-right">
                                <nav class="main-navigation mr-0">
                                    ...
                                    <ul class="menu">
                                        <li class="menu-item "><a href="#" class="dropdown-toggle" data-toggle="dropdown"> {{ Auth::user()->email }}<span class="caret"></span></a>
                                ...
                                <ul class="menu">
                                    ...
                                    <li class="menu-item">
                                        @if(Auth::user()->role == 'admin')
                                            <a href="{{ url('/admin') }}" class="branding pull-left">Home</a>
                                        @else
