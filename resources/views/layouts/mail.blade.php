    ...
    <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td class="esd-email-paddings" valign="top">
                    ...
                    <tr>
                        <td class="esd-stripe" esd-custom-block-id="2816" align="center">
                            <table class="es-header-body" width="600" cellspacing="0" cellpadding="0" align="center">
                                <tbody>
                                <tr>
                                    <td class="esd-structure es-p10" esd-general-paddings-checked="false" align="left" bgcolor="#efefef" style="background-color: #efefef;">
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="580" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="esd-block-image" align="center" style="font-size: 0px;"><a href="{{config('app.url')}}" target="_blank"><img src="{{asset('/images/logo-icon.png')}}" alt="logo" title="logo" width="208" style="display: block;"></a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                                ...
                                                <td class="esd-container-frame" width="600" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr class="es-visible-simple-html-only">
                                                            <td align="center" class="esd-block-image" style="font-size: 0px;"><img class="adapt-img" src="{{asset('/images/slider-3.jpg')}}" alt style="display: block;" width="600"></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                ...
                <table cellpadding="0" cellspacing="0" bgcolor="#efefef" class="es-footer esd-footer-popover" align="center">
                    <tbody>
                    <tr>
                                ...
                                <tr>
                                    <td class="esd-structure es-p20t es-p20r es-p20l" align="left">
                                            ...
                                            <tr>
                                                <td width="200" class="es-m-p0r es-m-p20b esd-container-frame" valign="top" align="center">
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img class="adapt-img" src="{{asset('/images/logo-footer.png')}}" alt style="display: block;" width="200"></a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" align="right">
                                            <tbody>
                                            <tr>
                                                <td width="340" align="left" class="esd-container-frame">
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        <tbody>
                                                        <tr>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td esdev-links-color="#333333" align="center" class="esd-block-text es-p5t">
                                                                <p style="line-height: 200%; font-size: 13px;">© {{ date('Y') }} {{ config('app.name') }}. All rights reserved.</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
