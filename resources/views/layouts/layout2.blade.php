        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
            ...
            <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
              <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
                <div class="d-table m-auto">
                  <img id="main-logo" class="d-inline-block align-top mr-1" width="60%" src="{{ asset('images/new/logo.png') }}" alt="{{ zactra::translate_lang('Prudent Credit Solutions') }}" />
                </div>
              </a>
          ...
          <form action="#" class="main-sidebar__search w-100 border-right d-sm-flex d-md-none d-lg-none">
            <div class="input-group input-group-seamless ml-3">
              ...
              <input class="navbar-search form-control" type="text" placeholder="{{ zactra::translate_lang('Search for something...') }}" aria-label="Search" />
            </div>
          </form>
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link {{ \App\utills\zactra::areActiveRoute(['client.details.create']) }}" href="{{route('client.details.create')}}">
                  ...
                  <span>{{ zactra::translate_lang('ADD YOUR DETAILS') }}</span>
                </a>
              </li>
              @endif
              <li class="nav-item">
                <a class="nav-link" href="{{url('logout')}}">
                  <i class="material-icons">view_module</i>
                  <span>{{ zactra::translate_lang('Logout') }}</span>
                </a>
              </li>
            </ul>
          </div>
                  ...
                  <div class="dropdown-menu dropdown-menu-small" aria-labelledby="dropdownMenuLink">
                    <a class="dropdown-item" href="#">
                      ...
                      <div class="notification__content">
                        <span class="notification__category">{{ zactra::translate_lang('Analytics') }}</span>
                        <p>
                          {{ zactra::translate_lang('Your website’s active users count increased by ') }}<span class="text-success text-semibold">{{ zactra::translate_lang('28%') }}</span> {{ zactra::translate_lang('in the last week. Great
                          job!') }}
                        </p>
                      </div>
                    </a>
                    <a class="dropdown-item" href="#">
                      ...
                      <div class="notification__content">
                        <span class="notification__category">{{ zactra::translate_lang('Sales') }}</span>
                        <p>
                          {{ zactra::translate_lang('Last week your store’s sales count decreased by ') }}<span class="text-danger text-semibold">{{ zactra::translate_lang('5.52%') }}</span>{{ zactra::translate_lang('. It could have been
                          worse!') }}
                        </p>
                      </div>
                    </a>
                    <a class="dropdown-item notification__all text-center" href="#">{{ zactra::translate_lang('View all Notifications ') }}</a>
                  </div>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <img class="user-avatar rounded-circle mr-2" src="https://i.pinimg.com/originals/0c/3b/3a/0c3b3adb1a7530892e55ef36d3be6cb8.png" alt="User Avatar" />
                    <span class="d-none d-md-inline-block">{{ $client->full_name() }}</span>
                  </a>
                  <div class="dropdown-menu dropdown-menu-small">
                    <a class="dropdown-item text-danger" href="{{ route('client.details.edit',Auth::user()->id) }}"><i class="material-icons text-danger">account_circle</i>{{ zactra::translate_lang('Profile') }}</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-danger" href="{{url('logout')}}"> <i class="material-icons text-danger"></i>{{ zactra::translate_lang('Logout') }} </a>
                  </div>
                </li>
              </ul>
              <nav class="nav">
