<tr>
    <td class="esd-email-paddings">
        <table cellpadding="0" cellspacing="10" class="es-content esd-header-popover" align="center">
            <tbody>
            <tr>
                    ...
                    <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                        ...
                        <tr>
                            <td class="esd-structure es-p20t es-p15r es-p15l" align="left">
                                <!--[if mso]><table width="570" cellpadding="0" cellspacing="0"><tr><td width="367" valign="top"><![endif]-->
                                <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                    <tbody>
                                    <tr>
                                        <td width="367" class="es-m-p0r es-m-p20b esd-container-frame" valign="top" align="center">
                                ...
                                <!--[if mso]></td><td width="20"></td><td width="183" valign="top"><![endif]-->
        ...
        <table cellpadding="0" cellspacing="10" class="es-content" align="center">
            <tbody>
            <tr>
                <td class="esd-structure es-p20t es-p15r es-p15l" align="left">
                        ...
                        <tr>
                            <td width="177" class="es-m-p20b esd-container-frame" align="center">
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td align="left" class="esd-block-text">
                                            <p>{{strtoupper($client->full_name)}}</p>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
            ...
            <tr>
                <td class="esd-stripe" align="center" esd-custom-block-id="78014">
                    <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                        ...
                        @if(!empty($client->clientDetails) && !empty($client->clientDetails->phone_number))
                            <tr>
                                <td class="esd-structure es-p20t es-p15r es-p15l" align="left">
                                    <!--[if mso]><table width="570" cellpadding="0" cellspacing="0"><tr><td width="197" valign="top"><![endif]-->
                                    <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                        ...
                                        <tr>
                                            <td width="177" class="es-m-p20b esd-container-frame" align="center">
                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td align="left" class="esd-block-text">
                                                            <p>{{$client->ClientDetails->phone_number}}</p>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
