    ...
    <div class="px-3 mt-5 pt-3">
        <div class="row">
          <div class="col-md-12 py-4">
            ...
            <p class="text-center">It's our news room. Here You find all News about our Website. Please visit here continuously to stay updated.</p>
          </div>
        </div>
                      ...
                      <div class="mt-5 shadow-sm px-4 py-4">
                          ...
                          @foreach ($mostviewes as $key1 => $value1)
                            <div class="row mb-4">
                              ...
                              <div class="col-md-8">
                                <a href="{{ route('home.blog.show',$value1->url) }}"><h5 class="text-info">{{ ucfirst($value1->title) }}</h5></a>
