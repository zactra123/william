  ...
  <div class="col-md-12 col-lg-12 col-sm-12 col-12">
    <div class="row">
      <div class="col-md-6 col-lg-6 col-sm-12 col-12">
        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="{{ zactra::translate_lang('Client Email') }}" required autocomplete="email" />
      </div>
      <div class="col-md-6 col-lg-6 col-sm-12 col-12">
        <input id="phone_number" class="phone form-control" type="text" name="phone_number" value="{{ !empty(old('phone_number')) ? old('phone_number') : null}}" required autocomplete="phone_number" placeholder="{{ zactra::translate_lang('Phone Number') }}" />
      </div>
    </div>
    <div class="row">
      <div class="col-md-12 col-lg-12 col-sm-12 col-12">
