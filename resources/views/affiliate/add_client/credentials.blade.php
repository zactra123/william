<form id="add_client_4" data-client="{{$client!=null?$client->id:""}}" data-id="4" data-type="only_broker" class="add-client additional-reg {{$current_page}}" novalidate>
  ...
  <div class="col-md-12 col-lg-12 col-sm-12 col-12">
    <div class="login-type-title">
      ...
      <p>{{ zactra::translate_lang('If You are Not Register') }} <a href="https://www.creditkarma.com/signup/" target="_blank">{{ zactra::translate_lang('Click here to register') }}</a></p>
    </div>
    <div class="row">
  ...
  <div class="col-md-12 col-lg-12 col-sm-12 col-12">
    <div class="login-type-title">
      ...
      <p>{{ zactra::translate_lang('If You are Not Register') }} <a href="https://usa.experian.com/#/registration?offer=at_fcras100&br=exp&dAuth=true" target="_blank">{{ zactra::translate_lang('Click here to register') }}</a></p>
    </div>
    <div class="row">
      <div class="col-md-6 col-lg-6 col-sm-12 col-12">
      ...
      <div class="col-md-6 col-lg-6 col-sm-12 col-12">
        <input type="text" name="client[ex_question]" placeholder="{{ zactra::translate_lang('Answer to security question') }}" />
      </div>
      <div class="col-md-6 col-lg-6 col-sm-12 col-12">
  ...
  <div class="col-md-12 col-lg-12 col-sm-12 col-12">
    <div class="login-type-title">
      ...
      <p>If You are Not Register <a href="https://service.transunion.com/dss/orderStep1_form.page?" target="_blank">{{ zactra::translate_lang('Click here to register') }}</a></p>
    </div>
    <div class="row">
      <div class="col-md-6 col-lg-6 col-sm-12 col-12">
      ...
      <div class="col-md-6 col-lg-6 col-sm-12 col-12">
        <input type="text" name="client[tu_question]" placeholder="{{ zactra::translate_lang('Security Question') }}" />
      </div>
      <div class="col-md-6 col-lg-6 col-sm-12 col-12">
        <input type="text" name="client[tu_answer]" placeholder="{{ zactra::translate_lang('Security Answer') }}" />
      </div>
    </div>
  </div>
  ...
  <div class="col-md-12 col-lg-12 col-sm-12 col-12">
    <div class="login-type-title">
      ...
      <p>{{ zactra::translate_lang('If You are Not Register') }} <a href="https://service.transunion.com/dss/orderStep1_form.page?" target="_blank">{{ zactra::translate_lang('Click here to register') }}</a></p>
    </div>
    <div class="row">
      <div class="col-md-6 col-lg-6 col-sm-12 col-12">
  ...
  <div class="col-md-12 col-lg-12 col-sm-12 col-12">
    <div class="login-type-title">
      ...
      <p>{{ zactra::translate_lang('If You are Not Register') }} <a href="https://my.equifax.com/consumer-registration/UCSC/#/personal-info" target="_blank">{{ zactra::translate_lang('Click here to register') }}</a></p>
    </div>
    <div class="row">
      <div class="col-md-6 col-lg-6 col-sm-12 col-12">
