		...
		<div class="card w-75">
			<div class="card-body w-100">
				...
				@if(empty($source) || $source == 'experian')
  				<div class="col-sm-12">
  					<label> <img class="report_access" src="{{asset('images/report_access/ex_logo_1.png')}}" width="200"> {{ zactra::translate_lang('If You are Not Register') }} <a href="https://usa.experian.com/#/registration?offer=at_fcras100&br=exp&dAuth=true" target="_blank">{{ zactra::translate_lang('Click here to register') }}</a></label>
  					<div class="form-group m-1  font">
				...
				@if(empty($source) || $source == 'transunion_member')
  				<div class="col-sm-12">
  					<label> <img class="report_access" src="{{asset('images/report_access/tu_logo_1.png')}}" width="200"> {{ zactra::translate_lang('If You are Not Register') }} <a href="https://membership.tui.transunion.com/tucm/orderStep1_form.page?offer=3BM10246&PLACE_CTA=top_right_search" target="_blank">{{ zactra::translate_lang('Click here to register') }}</a></label>
  					<div class="form-group  m-1 font">
				...
				@if(empty($source) || $source == 'transunion_dispute')
  				<div class="col-sm-12">
  					<label> <img class="report_access" src="{{asset('images/report_access/tu_logo_1.png')}}" width="200"> {{ zactra::translate_lang('(DISPUTE) If You are Not Register') }} <a href="https://service.transunion.com/dss/orderStep1_form.page?" target="_blank">{{ zactra::translate_lang('Click here to register') }}</a></label>
  					<div class="form-group  m-1 font">
				...
				@if(empty($source) || $source == 'equifax')
  				<div class="col-sm-12">
  					<label> <img class="report_access" src="{{asset('images/report_access/eq_logo_1.png')}}" width="200"> {{ zactra::translate_lang('If You are Not Register') }} <a href="https://my.equifax.com/consumer-registration/UCSC/#/personal-info" target="_blank">{{ zactra::translate_lang('Click here to register') }}</a></label>
  					<div class="form-group  m-1 font">
