              ...
              <div class="col-md-5">
                ...
                <div class="row mt20 title-ex_statement-{{$ex_statement['ex_statement']->id}}" style="font-weight: bold;">
                  <div class="col-md-12">
                    ...
                    <input
                      type="radio"
                      id="ex_statement-{{$ex_statement['ex_statement']->id}}"
                      data-name="{{$ex_statement['ex_statement']->id}}"
                      data-price="{{$ex_statement['price']['inaccurate']}}"
                      class="ex_statement_fix"
                      name="ex_statement[{{$ex_statement['ex_statement']->id}}][type]"
                      value="fix"
                    />
                    <label class="p-2" for="fraudulent">or</label>
                    <label for="delete">Delete </label>
                    <input
                      ...
                      class="ex_statement_fix"
                      data-name="{{$ex_statement['ex_statement']->id}}"
                      data-price="{{$ex_statement['price']['not_mine']}}"
                      name="ex_statement[{{$ex_statement['ex_statement']->id}}][type]"
                      value="delete"
                    />
                  </div>
              ...
              <div class="col-md-5">
                ...
                <div class="row mt20 title-tu_statement-{{$tu_statement['tu_statement']->id}}" style="font-weight: bold;">
                  <div class="col-md-12">
                    <div class="col-md-12 p-0">DISPUTE TYPE</div>
                    <label for="fix">Fix</label>
                    <input type="radio" id=tu-{{$tu_statement['tu_statement']->id}}" data-name="{{$tu_statement['tu_statement']->id}}" data-price="{{$tu_statement['price']['inaccurate']}}" class="tu_statement_fix"
                    name="tu_statement[{{$tu_statement['tu_statement']->id}}][type]" value="fix">
                    <label class="p-2" for="fraudulent">or</label>
                    <label for="delete">Delete </label>
                    <input
                      type="radio"
                      class="tu_statement_fix"
                      data-name="{{$tu_statement['tu_statement']->id}}"
                      data-price="{{$tu_statement['price']['inaccurate']}}"
                      name="tu_statement[{{$tu_statement['tu_statement']->id}}][type]"
                      value="delete"
                    />
                  </div>
                </div>
      ...
      @if(!empty($data['ex_public'])) @foreach($data['ex_public'] as $ex_public)
              ...
              <div class="col-md-6 p-0">
                ...
                <div class="row mt20 title-ex_public-{{$ex_public['ex_public']->id}}" style="font-weight: bold;">
                  ...
                  <div class="col-md-12">
                    ...
                    <input
                      type="radio"
                      id="ex_public-{{$ex_public['ex_public']->id}}"
                      data-name="{{$ex_public['ex_public']->id}}"
                      data-price="{{$ex_public['price']['inaccurate']}}"
                      class="ex_public_fix"
                      name="ex_public[{{$ex_public['ex_public']->id}}][type]"
                      value="inaccurate"
                    />
                    <label class="p-2" for="fraudulent">or</label>
              ...
              <div class="col-md-6">
                ...
                <div class="row mt20 title-tu_public-{{$tu_public['tu_public']->id}}" style="font-weight: bold;">
                  ...
                  <div class="col-md-12">
                    ...
                    <input
                      type="radio"
                      id="tu_public-{{$tu_public['tu_public']->id}}"
                      data-name="{{$tu_public['tu_public']->id}}"
                      data-price="{{$tu_public['price']['inaccurate']}}"
                      class="tu_public_fix"
                      name="tu_public[{{$tu_public['tu_public']->id}}][type]"
                      value="inaccurate"
                    />
                    <label class="p-2" for="fraudulent">or</label>
                    <label for="not-mine">Not Mine </label>
              ...
              <div class="col-md-6">
                ...
                <div class="row mt20 title-eq_public-{{$eq_public['eq_public']->id}}" style="font-weight: bold;">
                  ...
                  <div class="col-md-6">
                    ...
                    <input
                      type="radio"
                      id="eq_public-{{$eq_public['eq_public']->id}}"
                      data-name="{{$eq_public['eq_public']->id}}"
                      data-price="{{$eq_public['price']['inaccurate']}}"
                      class="eq_public_fix"
                      name="eq_public[{{$eq_public['eq_public']->id}}][type]"
                      value="inaccurate"
                    />
                    <label class="p-2" for="fraudulent">or</label>
                    <label for="not-mine">Not Mine </label>
        ...
        @if(!empty($data['ex_account'])) @foreach($data['ex_account'] as $ex_account)
          ...
          <div class="chart-report title-ex_account-{{$ex_account['ex_account']->id}}">
              ...
              <div class="col-md-6">
                ...
                <div class="row mt20 title-ex_account-{{$ex_account['ex_account']->id}}" style="font-weight: bold;">
                  ...
                  <div class="col-md-12">
                    ...
                    <input
                      type="radio"
                      id="ex_account-{{$ex_account['ex_account']->id}}"
                      data-name="{{$ex_account['ex_account']->id}}"
                      data-price="{{$ex_account['price']['inaccurate']}}"
                      class="ex_account_fix"
                      name="ex_account[{{$ex_account['ex_account']->id}}][type]"
                      value="inaccurate"
                    />
                    <label class="p-2" for="fraudulent">or</label>
                    <label for="not-mine">Not Mine </label>
            ...
            <?php $string =  strtoupper(str_replace('Never late', '',$ex_account['ex_account']->status))?> @if(strpos($string, "LATE")!==false && strpos($string, "OPEN")!==false)
              ...
              <div class="col-md-6">
                ...
                <div class="row mt20 title-tu_account-{{$tu_account['tu_account']->id}}" style="font-weight: bold;">
                  ...
                  <div class="col-md-12">
                    ...
                    <input
                      type="radio"
                      id="tu_account-{{$tu_account['tu_account']->id}}"
                      data-name="{{$tu_account['tu_account']->id}}"
                      data-price="{{$tu_account['price']['inaccurate']}}"
                      class="tu_account_fix"
                      name="tu_account[{{$tu_account['tu_account']->id}}][type]"
                      value="inaccurate"
                    />
                    <label class="p-2" for="fraudulent">or</label>
                    <label for="not-mine">Not Mine </label>
            ...
            <div class="row mt20" style="font-weight: bold;">
              ...
              <div class="row mt20 title-eq_account-{{$eq_account['eq_account']->id}}" style="font-weight: bold;">
                ...
                <div class="col-md-12">
                  ...
                  <input
                    type="radio"
                    id="eq_account-{{$eq_account['eq_account']->id}}"
                    data-name="{{$eq_account['eq_account']->id}}"
                    data-price="{{$eq_account['price']['inaccurate']}}"
                    class="eq_account_fix"
                    name="eq_account[{{$eq_account['eq_account']->id}}][type]"
                    value="inaccurate"
                  />
                  <label class="p-2" for="fraudulent">or</label>
                  <label for="not-mine">Not Mine </label>
