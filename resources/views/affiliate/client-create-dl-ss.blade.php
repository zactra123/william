            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="ms-ua-box">
                        ...
                        {!! Form::open(['route'=>['affiliate.storeDLSS', $clients->id],'method' => 'POST','files' => 'true','enctype'=>'multipart/form-data', 'class' => 'm-form m-form--label-align-right', "id" => "doc_sunb"]) !!}
                        ...
                        @if( $clients->clientAttachments->whereIn("category", ["DL","SS"])->count() == 2)
