...
<section class="register">
  ...
  <div class="register-form" data-id="1">
    ...
    <div class="ms-ua-box">
      {!! Form::open(['route' => ['affiliate.important'], 'method' => 'POST', 'id' => 'clientDetailsForm', 'class' => 'm-form m-form--label-align-right']) !!} @csrf
      ...
      <div class="form-group w-100 mb-0">
        <div class="register_or">
          <label for="social_number" class="social_number">
            {{ Form::text('ssn', $client->clientDetails->ssn, ['class' => 'form-control m-input ssn', 'id'=>"social_number", 'placeholder' => 'Social security number']) }} @error('ssn')
          ...
          <label for="ein_number" class="ein_number">
            {{ Form::text('ein', $client->clientDetails->ein, ['class' => 'form-control m-input ein', 'id'=>"ein_number", 'placeholder' => 'EIN Number']) }} @error('ssn')
            <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
            </span>
            @enderror
      ...
      <div class="form-group w-100 mb-0">
        {{ Form::text('phone_number', $client->clientDetails->phone_number, ['class' => 'form-control m-input phone', 'id'=>"phone_number", 'placeholder' => 'Phone Number']) }} @error('phone_number')
        <span class="invalid-feedback" role="alert">
          <strong>{{ $message }}</strong>
        </span>
        @enderror
