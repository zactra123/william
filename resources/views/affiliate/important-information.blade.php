...
<section class="register">
	...
	<div class="register-form" data-id="1">
		<h3 class="title">{{ zactra::translate_lang('Registration') }}</h3>
		...
		<div class="ms-ua-box">
			...
			<div class="form-group w-100 mb-0">
				<input id="address" type="text" class="form-control" name="address" value="{{ old('address') }}" required autocomplete="address" placeholder="{{ zactra::translate_lang('Full Address') }}" />
				@error('address')
				<span class="invalid-feedback" role="alert">
					<strong>{{ $message }}</strong>
				</span>
			...
			<div class="basic-button">
				<input class="login" type="submit" value="{{ zactra::translate_lang('Save') }}" name="" />
			</div>
			{!! Form::close() !!}
		</div>
	</div>
