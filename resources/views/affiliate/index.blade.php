...
<section class="register ">
	...
	<div class="register-form big">
		<h3 class="title">{{ zactra::translate_lang('Finish') }}</h3>
		<div class="registration-stages">
			<div class="registration-stages">
				<a class="registration-stage active" data-id="1">
					<div class="stage-img">
					...
					<div class="stage-name">
						<h3 class="stage-title">{{ zactra::translate_lang('Registration Type') }}</h3>
					</div>
				</a>
				...
				<a class="registration-stage active prepare" data-id="finish">
					<div class="stage-img">
		...
		<div class="finish active" data-id="finish">
			...
			<p>
				{{ zactra::translate_lang('“Debt means enslavement to the past, no matter how much you want to plan well for the future and live according to your own standards today. Unless you’re free from the bondage of paying for your past, you can’t responsibly live in
				the present and plan for the future.” - Tsh Oxenreider') }}
			</p>
			...
			<a class="finish-reg basic-button pointer">{{ zactra::translate_lang('Continue') }}</a>
		</div>
	</div>
	@endif
					...
					<div class="col-md-10 col-sm-12 col-12 pt-4">
						<div class="card">
							<div class="card-header">
								<label class="header m-2">{{ zactra::translate_lang('Clients List') }}</label>
							</div>
							<div class="card-body">
									...
									<table class="table">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a class="btn btn-primary" href="{{route('affiliate.client.profile', $client->user->id)}}" role="button">{{ zactra::translate_lang('Client Profile') }}</a>
												</td>
											</tr>
											@endforeach
										</tbody>
