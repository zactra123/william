	...
	<div class="row justify-content-center">
		<div class="col-md-6">
	      ...
	      <div class="w-25 alert alert-success alert-block flash">
			...
			<p>{{ zactra::translate_lang('Please enter complete information which is asked below to reset your login information!') }}</p>
			...
			<div class="form-group col-md-12 text-center"> {{ zactra::translate_lang('OR') }} </div>
			<div class="row">
				<div class="form-group col-md-6">
					<div class="p-0">
		...
		<p class="pt-4 fs-12 text-center">
			<span class="fs-18">{{ zactra::translate_lang('Want to login to your account?') }} <a class="fs-18 theme-color-dark" href="{{route('login')}}">{{ zactra::translate_lang('Sign In') }}</a></span>
		</p>
	</div>
	</div>
</section>
