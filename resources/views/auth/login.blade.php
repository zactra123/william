    ...
    <section class="login">
        ...
        <div class="login-form">
            ...
            <div class="login-social">
                <a class="login-facebook" href="{{route('facebook.login')}}" target="_blank" title="facebook" rel="nofollow">
                ...
                <a class="login-google" href="{{route('google.login')}}" target="_blank" title="google" rel="nofollow">
