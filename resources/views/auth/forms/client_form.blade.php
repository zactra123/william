<div class="registration-form" data-type="client">
    <form id="register_form" method="POST" action="{{ route('register') }}">
        ...
        <input type="hidden" name="role" class="form-control fs-12" value="client">
          ...
          <div class="col-md-12 col-lg-12 col-sm-12 col-12">
            <label class="fs-18 bold theme-color-dark">Gender</label>
            <div class="row">
          ...
          <div class="col-md-12 col-lg-12 col-sm-12 col-12">
            <label class="fs-18 bold theme-color-dark">Password</label>
            <div class="row">
          ...
          <div class="col-md-12 col-lg-12 col-sm-12 col-12">
            <label class="fs-18 bold theme-color-dark">Security Question</label>
            <div class="row">
