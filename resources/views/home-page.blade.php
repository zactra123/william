    ...
    <div class="container">
        <div class="about-us-inner row">
            <div class="information-block col-12 col-md-6">
                <p>
                    In the 1800s, most credit transactions were conducted by businesses, not by consumers. As business transactions increased, commercial lenders needed to create a way to standardize credit evaluation. In 1841, the Mercantile Agency solicited information from correspondents throughout the United States to systemize a borrower's "character and assets." However, this data considered too subjective by many as the opinions noted racial, class, and gender biases. Subscribers to the Mercantile Agency (renamed R.G.
                </p>
            ...
            <div class="block col-12 col-md-6">
                <div class="help-description first" data-id="bankruptcies">
                    ...
                    <div class='modal-body'>
                        <h6>Bankruptcies</h6>
                        <p>
                            Lorem, ipsum, dolor sit amet consectetur adipisicing elit. Perferendis quibusdam atque alias autem temporibus, error maxime beatae est amet saepe, animi laboriosam perspiciatis ipsam nemo dicta, deleniti? Earum commodi animi, sed eius, eum nesciunt doloremque natus est error maxime et dolorum incidunt facilis iste soluta dolor quae, repudiandae! Eaque, facere porro voluptatem alias sapiente accusantium, ratione hic facilis, delectus voluptates quam. Esse minus ab ipsa eos cum beatae facilis est.
                        </p>
                    </div>
                </div>
...
<section class="education">
    <div class="container">
        ...
        <div class="education-inner row">
            <div class="text-block col-12 col-lg-4">
            ...
            <div class="img-block col-12 col-lg-7">
                <div class="credit-graph">
                    <div class="graph">
                        ...
                        <img id="graph_red" src="{{asset("images/new/red.png")}}" alt="credit_education">
