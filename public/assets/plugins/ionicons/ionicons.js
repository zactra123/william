...
//                 .map(function (e) {
//                     return e[0];
//                 })).length && (((d = n.createElement("style")).innerHTML = p.join() + "{visibility:hidden}.hydrated{visibility:inherit}"), d.setAttribute("data-styles", ""), n.head.insertBefore(d, n.head.firstChild)),
//             (function (e, n, t) {
...
//                 (!(!(n.search.indexOf("core=es5") > 0 || "file:" === n.protocol) && e.customElements && e.customElements.define && e.fetch && e.CSS && e.CSS.supports && e.CSS.supports("color", "var(--c)") && "noModule" in t) ||
//                     (function (e) {
//                         try {
...
//             : ((d.src = i + "ionicons.suuqn5vt.js"), d.setAttribute("type", "module"), d.setAttribute("crossorigin", !0)),
