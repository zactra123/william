...
$(document).ready(function(){
 ...
 $(document).ready(function(){
 	...
 	$('#login_form input[type="text"], #login_form input[type="tel"], #login_form input[type="email"], #login_form input#register_password').on('propertychange input', function(){
 		$input = $(this);
 		$val = $input.val();
 		$type = $input.attr('type');
 		Valid($input, $val, $type, 'input');
...
$(document).ready(function(){
	if( $(document).innerWidth() < 991 ){
		...
		console.log($text_2.text().length);
