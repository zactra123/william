...
!(function (a) {
  ...
  var b = jQuery.fn.revolution,
    c = { alias: "KenBurns Min JS", name: "revolution.extensions.kenburn.min.js", min_core: "5.0", version: "1.2.0" };
  jQuery.extend(!0, b, {
    ...
    startKenBurn: function (a, d, e) {
      ...
      var m = function (a, b, c, d, e, f, g) {
        ...
        o = function (a, b, c) {
          ...
          (h.start.transformOrigin = c.bgposition), (h.start.scale = d), (h.end.scale = e), (c.rotatestart = 0 === c.rotatestart ? 0.01 : c.rotatestart), (h.start.rotation = c.rotatestart + "deg"), (h.end.rotation = c.rotateend + "deg");
          var o = n(c, a, b, f, h);
      ...
      s.pause(),
        ...
        s.add(punchgs.TweenLite.fromTo(q, f.duration / 1e3, r.starto, r.endo), 0),
        s.progress(e),
        s.play(),
        a.data("kbtl", s);
    },
