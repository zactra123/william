...
!(function (a) {
  ...
  var b = jQuery.fn.revolution,
    c = b.is_mobile(),
    d = { alias: "Parallax Min JS", name: "revolution.extensions.parallax.min.js", min_core: "5.3", version: "2.2.0" };
  jQuery.extend(!0, b, {
    checkForParallax: function (a, e) {
      ...
      if (!f.done) {
        ...
        ("3D" != f.type && "3d" != f.type) ||
          ...
          ("3D" == f.type || "3d" == f.type) && e.c.find(".tp-static-layers").length > 0 && (punchgs.TweenLite.set(e.c.find(".tp-static-layers"), { top: 0, left: 0, width: "100%", height: "100%" }), g(e.c.find(".tp-static-layers"))),
    ...
    scrollHandling: function (a, d) {
      ...
      if (((a.scrollproc = i), b.callBackHandling && b.callBackHandling(a, "parallax", "start"), g.enable)) {
        var j = 1 - Math.abs(i);
        (j = j < 0 ? 0 : j),
          jQuery.isNumeric(g.visible_area) || (g.visible_area.indexOf("%") !== -1 && (g.visible_area = parseInt(g.visible_area) / 100)),
          1 - g.visible_area <= j ? a.inviewport || ((a.inviewport = !0), b.enterInViewPort(a)) : a.inviewport && ((a.inviewport = !1), b.leaveViewPort(a));
      }
        ...
        if (("scroll" == h.type || "scroll+mouse" == h.type || "mouse+scroll" == h.type) && h.pcontainers)
          for (var k = 0; k < h.pcontainers.length; k++)
            if (h.pcontainers[k].length > 0) {
              ...
              l.data("parallaxoffset", n), punchgs.TweenLite.set(l, { overwrite: "auto", force3D: "auto", y: n });
            }
        if (h.bgcontainers)
          for (var k = 0; k < h.bgcontainers.length; k++) {
            var o = h.bgcontainers[k],
              ...
              n = i * -(p * a.conh) || 0;
            punchgs.TweenLite.set(o, { position: "absolute", top: "0px", left: "0px", backfaceVisibility: "hidden", force3D: "true", y: n + "px" });
          }
      }
