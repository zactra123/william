...
!(function ($) {
    ...
    var _R = jQuery.fn.revolution,
        _ISM = _R.is_mobile(),
        extension = { alias: "Actions Min JS", name: "revolution.extensions.actions.min.js", min_core: "5.3", version: "2.0.4" };
    jQuery.extend(!0, _R, {
    ...
    var checkActions_intern = function (a, b, c) {
                ...
                jQuery.each(c, function (c, d) {
                    (d.delay = parseInt(d.delay, 0) / 1e3),
                        ...
                        b.fullscreen_esclistener ||
                            ("exitfullscreen" != d.action && "togglefullscreen" != d.action) ||
                    ...
                    switch (
                        (a.on(d.event, function () {
                            ...
                            if ("stoplayer" == d.action || "togglelayer" == d.action || "startlayer" == d.action) {
                                if (c.length > 0) {
                                    var e = c.data();
                                    "startlayer" == d.action || ("togglelayer" == d.action && "in" != c.data("animdirection"))
                                        ? ((e.animdirection = "in"),
                                          (e.triggerstate = "on"),
                                          _R.toggleState(e.layertoggledby),
                                          _R.playAnimationFrame &&
                                              (clearTimeout(e.triggerdelay),
                                              (e.triggerdelay = setTimeout(function () {
                                                  _R.playAnimationFrame({ caption: c, opt: b, frame: "frame_0", triggerdirection: "in", triggerframein: "frame_0", triggerframeout: "frame_999" });
                                              }, 1e3 * d.delay))))
                                        : ("stoplayer" == d.action || ("togglelayer" == d.action && "out" != c.data("animdirection"))) &&
                                          ((e.animdirection = "out"),
                                          (e.triggered = !0),
                                          (e.triggerstate = "off"),
                                          ...
                                          _R.endMoveCaption &&
                                              (clearTimeout(e.triggerdelay),
                                              (e.triggerdelay = setTimeout(function () {
                                                  _R.playAnimationFrame({ caption: c, opt: b, frame: "frame_999", triggerdirection: "out", triggerframein: "frame_0", triggerframeout: "frame_999" });
                                              }, 1e3 * d.delay))));
                                }
                            } else
                                !_ISM ||
                                ("playvideo" != d.action &&
                                    ...
                                    ? ((d.delay = "NaN" === d.delay || NaN === d.delay ? 0 : d.delay),
        ...
        actionSwitches = function (tnc, opt, a, _nc) {
            switch (a.action) {
                ...
                case "toggleslider":
                    (opt.noloopanymore = 0),
                        "playing" == opt.sliderstatus ? (opt.c.revpause(), (opt.forcepause_viatoggle = !0), _R.unToggleState(opt.slidertoggledby)) : ((opt.forcepause_viatoggle = !1), opt.c.revresume(), _R.toggleState(opt.slidertoggledby));
                    break;
                case "pauseslider":
          ...
          switch (
            (a.on(d.event, function () {
              ...
              if ("stoplayer" == d.action || "togglelayer" == d.action || "startlayer" == d.action) {
                ...
                !_ISM || ("playvideo" != d.action && "stopvideo" != d.action && "togglevideo" != d.action && "mutevideo" != d.action && "unmutevideo" != d.action && "toggle_mute_video" != d.action && "toggle_global_mute_video" != d.action)
                  ? ((d.delay = "NaN" === d.delay || NaN === d.delay ? 0 : d.delay),
                    punchgs.TweenLite.delayedCall(
                      d.delay,
                      function () {
