...
!(function (a) {
  ...
  var b = jQuery.fn.revolution,
    c = b.is_mobile(),
    d = { alias: "Video Min JS", name: "revolution.extensions.video.min.js", min_core: "5.3", version: "2.0.2" };
  jQuery.extend(!0, b, {
      ...
      return (
        ...
        void a.find(".tp-audiolayer").each(function () {
          ...
          0 === a.find("audio").length &&
            ...
            ("auto" != d.pre && "canplaythrough" != d.pre && "canplay" != d.pre && "progress" != d.pre) || (void 0 === c.audioqueue && (c.audioqueue = []), c.audioqueue.push(d), b.manageVideoLayer(a, c)));
        })
      );
    },
    ...
    resetVideo: function (a, d, f) {
      ...
      switch (g.videotype) {
        case "youtube":
          ...
          0 == a.find(".tp-videoposter").length && 1 !== g.bgvideo && f !== !0 && punchgs.TweenLite.to(a.find("iframe"), 0.3, { autoAlpha: 1, display: "block", ease: punchgs.Power3.easeInOut });
          break;
        case "vimeo":
    ...
    prepareCoveredVideo: function (a, c, d) {
      var e = d.find("iframe, video"),
        ...
        l = (j / i) * 100;
      i > j
        ? punchgs.TweenLite.to(e, 0.001, { height: k + "%", width: "100%", top: -(k - 100) / 2 + "%", left: "0px", position: "absolute" })
        : punchgs.TweenLite.to(e, 0.001, { width: l + "%", height: "100%", left: -(l - 100) / 2 + "%", top: "0px", position: "absolute" }),
    ...
    checkVideoApis: function (a, b, c) {
      ...
      if (
        ((void 0 != a.data("ytid") || (a.find("iframe").length > 0 && a.find("iframe").attr("src").toLowerCase().indexOf("youtube") > 0)) && (b.youtubeapineeded = !0),
      ...
      if (
        ((void 0 != a.data("vimeoid") || (a.find("iframe").length > 0 && a.find("iframe").attr("src").toLowerCase().indexOf("vimeo") > 0)) && (b.vimeoapineeded = !0),
    ...
    manageVideoLayer: function (a, g, i, j) {
      ...
      switch (((w = l.nextslideatend === !0 ? "" : w), (l.videotype = x), z)) {
        ...
        case "youtube":
          (v = "https"),
            "none" == u && ((m = m.replace("controls=1", "controls=0")), m.toLowerCase().indexOf("controls") == -1 && (m += "&controls=0")),
      ...
      "none" != a.data("dottedoverlay") && void 0 != a.data("dottedoverlay") && 1 != a.find(".tp-dottedoverlay").length && a.append('<div class="tp-dottedoverlay ' + a.data("dottedoverlay") + '"></div>'),
        ...
        1 == a.data("bgvideo") && punchgs.TweenLite.set(a.find("video, iframe"), { autoAlpha: 0 });
    },
  });
  var f = function (a, b, c) {
    ...
    h = function (a, d, f) {
      ...
      if ((k.attr("id", n), f && a.data("startvideonow", !0), 1 !== a.data("videolistenerexist")))
        switch (h.videotype) {
          case "youtube":
              ...
              events: {
                onStateChange: function (c) {
                  ...
                  if (c.data == YT.PlayerState.PLAYING)
                    punchgs.TweenLite.to(a.find(".tp-videoposter"), 0.3, { autoAlpha: 0, force3D: "auto", ease: punchgs.Power3.easeInOut }),
                      punchgs.TweenLite.to(a.find("iframe"), 0.3, { autoAlpha: 1, display: "block", ease: punchgs.Power3.easeInOut }),
                      "mute" == a.data("volume") || b.lastToggleState(a.data("videomutetoggledby")) || d.globalmute === !0 ? r.mute() : (r.unMute(), r.setVolume(parseInt(a.data("volume"), 0) || 75)),
                      (d.videoplaying = !0),
                      l(a, d),
                    ...
                    !q &&
                      ...
                      (punchgs.TweenLite.to(a.find(".tp-videoposter"), 0.3, { autoAlpha: 1, force3D: "auto", ease: punchgs.Power3.easeInOut }), punchgs.TweenLite.to(a.find("iframe"), 0.3, { autoAlpha: 0, ease: punchgs.Power3.easeInOut })),
                      c.data != -1 &&
                        3 != c.data &&
                        ((d.videoplaying = !1),
                        (d.tonpause = !1),
                      ...
                      0 == c.data && 1 == a.data("nextslideatend")
                        ? (i(), a.data("nextslideatend-triggered", 1), d.c.revnext(), m(a, d))
                        : (m(a, d),
                          (d.videoplaying = !1),
                          f.trigger("starttimer"),
                          d.c.trigger("revolution.slide.onvideostop", g(r, "youtube", a.data())),
              ...
              if (
                ...
                y.addEvent("play", function (c) {
                  a.data("nextslidecalled", 0),
                    ...
                    l(a, d),
                    p ? d.c.trigger("stoptimer") : (d.videoplaying = !1),
                    "mute" == a.data("volume") || b.lastToggleState(a.data("videomutetoggledby")) || d.globalmute === !0 ? y.api("setVolume", "0") : y.api("setVolume", parseInt(a.data("volume"), 0) / 100 || 0.75),
                    b.toggleState(h.videotoggledby);
                }),
                ...
                y.addEvent("finish", function (c) {
                  m(a, d),
                    ...
                    1 == a.data("nextslideatend") && (a.data("nextslideatend-triggered", 1), d.c.revnext()),
                    (void 0 != d.currentLayerVideoIsPlaying && d.currentLayerVideoIsPlaying.attr("id") != a.attr("id")) || b.unToggleState(h.videotoggledby);
                }),
      ...
      void 0 != u &&
        ...
        f(p, "timeupdate", function () {
          var b = (100 / p.duration) * p.currentTime,
            ...
            f = p.currentTime;
          if ((void 0 != x && (x.value = b), 0 != c && c != -1 && Math.abs(c - f) <= 0.3 && c > f && 1 != a.data("nextslidecalled")))
            if (r) {
              p.play();
              var g = e(a.data("videostartat"));
              g != -1 && (p.currentTime = g);
        ...
        f(p, "play", function () {
          ...
          l(a, d),
            s && "audio" != e
              ? ((d.videoplaying = !0), d.c.trigger("stoptimer"), d.c.trigger("revolution.slide.onvideoplay", g(p, "html5", k)))
              : ((d.videoplaying = !1), "audio" != e && d.c.trigger("starttimer"), d.c.trigger("revolution.slide.onvideostop", g(p, "html5", k))),
            punchgs.TweenLite.to(a.find(".tp-videoposter"), 0.3, { autoAlpha: 0, force3D: "auto", ease: punchgs.Power3.easeInOut }),
            punchgs.TweenLite.to(a.find(e), 0.3, { autoAlpha: 1, display: "block", ease: punchgs.Power3.easeInOut });
        ...
        f(p, "pause", function () {
          ...
          !e &&
            ...
            (punchgs.TweenLite.to(a.find(".tp-videoposter"), 0.3, { autoAlpha: 1, force3D: "auto", ease: punchgs.Power3.easeInOut }), punchgs.TweenLite.to(a.find(c), 0.3, { autoAlpha: 0, ease: punchgs.Power3.easeInOut })),
        ...
        f(p, "ended", function () {
          i(),
            ...
            a.data("nextslideatend") === !0 &&
              p.currentTime > 0 &&
              (1 == !d.just_called_nextslide_at_htmltimer && (a.data("nextslideatend-triggered", 1), d.c.revnext(), (d.just_called_nextslide_at_htmltimer = !0)),
              setTimeout(function () {
                d.just_called_nextslide_at_htmltimer = !1;
              }, 1500)),
            a.removeClass("videoisplaying");
