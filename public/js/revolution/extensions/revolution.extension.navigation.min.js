...
!(function (a) {
  ...
  var b = jQuery.fn.revolution,
    c = b.is_mobile(),
    d = { alias: "Navigation Min JS", name: "revolution.extensions.navigation.min.js", min_core: "5.3", version: "1.3.2" };
  jQuery.extend(!0, b, {
        ...
        if ((d.pause(), (c = c > 1 ? 1 : c < 0 ? 0 : c), m(e) && (b || e.width > e.min_width) && f(c, d, a.c, e, a.slideamount, "tab"), m(g) && (b || g.width > g.min_width) && f(c, d, a.c, g, a.slideamount, "thumb"), m(h) && b)) {
          ...
          i.find(".tp-bullet").each(function (a) {
            ...
            "vertical" === h.direction
              ? (b.css({ top: (c - 1) * e + "px", left: "0px" }), i.css({ height: (c - 1) * e + b.outerHeight(), width: b.outerWidth() }))
              : (b.css({ left: (c - 1) * d + "px", top: "0px" }), i.css({ width: (c - 1) * d + b.outerWidth(), height: b.outerHeight() }));
          });
        }
        d.play(), x(a);
      }
    ...
    manageNavigation: function (a) {
      ...
      m(a.navigation.bullets) &&
        ("fullscreen" != a.sliderLayout &&
          ...
          ((a.navigation.bullets.h_offset_old = void 0 === a.navigation.bullets.h_offset_old ? a.navigation.bullets.h_offset : a.navigation.bullets.h_offset_old),
          (a.navigation.bullets.h_offset = "center" === a.navigation.bullets.h_align ? a.navigation.bullets.h_offset_old + c / 2 - d / 2 : a.navigation.bullets.h_offset_old + c - d)),
        ...
        m(a.navigation.arrows) &&
          ("fullscreen" != a.sliderLayout &&
            "fullwidth" != a.sliderLayout &&
            ((a.navigation.arrows.left.h_offset_old = void 0 === a.navigation.arrows.left.h_offset_old ? a.navigation.arrows.left.h_offset : a.navigation.arrows.left.h_offset_old),
            (a.navigation.arrows.left.h_offset = "right" === a.navigation.arrows.left.h_align ? a.navigation.arrows.left.h_offset_old + d : a.navigation.arrows.left.h_offset_old + c),
            (a.navigation.arrows.right.h_offset_old = void 0 === a.navigation.arrows.right.h_offset_old ? a.navigation.arrows.right.h_offset : a.navigation.arrows.right.h_offset_old),
            (a.navigation.arrows.right.h_offset = "right" === a.navigation.arrows.right.h_align ? a.navigation.arrows.right.h_offset_old + d : a.navigation.arrows.right.h_offset_old + c)),
        ...
        a.bind("revolution.slide.onafterswap revolution.nextslide.waiting", function () {
          ...
          if (j.enable === !0) {
            ...
            jQuery.each(f.thumbs[i].params, function (a, b) {
              ...
              j.right.j.html(k),
              punchgs.TweenLite.set(j.left.j.find(".tp-arr-imgholder"), { backgroundImage: "url(" + f.thumbs[h].src + ")" }),
              punchgs.TweenLite.set(j.right.j.find(".tp-arr-imgholder"), { backgroundImage: "url(" + f.thumbs[i].src + ")" });
          }
        }),
        l(j),
        l(n),
  ...
  var e = function (a, b) {
      ...
      m > 2 && ((q = o - (r + j) <= 0 ? (o - (r + j) < 0 - j ? r : q + j) : q), (q = o - j + r + k < j && o + (Math.round(m) - 2) * j < r ? o + (Math.round(m) - 2) * j : q)),
        ...
        a.hasClass("dragged") ||
          ("vertical" === i ? h.data("tmmove", punchgs.TweenLite.to(h, 0.5, { top: q + "px", ease: punchgs.Power3.easeInOut })) : h.data("tmmove", punchgs.TweenLite.to(h, 0.5, { left: q + "px", ease: punchgs.Power3.easeInOut })),
          h.data("offset", q));
    },
        ...
        o &&
          jQuery.each(o, function (a, c) {
            "vertical" === d.direction
              ? b.add(punchgs.TweenLite.set(c, { top: a * (k + parseInt(void 0 === d.space ? 0 : d.space, 0)), width: j + "px", height: k + "px" }))
              : "horizontal" === d.direction && b.add(punchgs.TweenLite.set(c, { left: a * (j + parseInt(void 0 === d.space ? 0 : d.space, 0)), width: j + "px", height: k + "px" }));
          }),
        b
      );
    },
      ...
      if ("on" === c.navigation.mouseScrollNavigation || "carousel" === c.navigation.mouseScrollNavigation) {
        ...
        a.on("mousewheel DOMMouseScroll", function (f) {
          ...
          "carousel" == c.navigation.mouseScrollNavigation && (k = l = !1),
            j == -1
              ? h.pixelY < d
                ? (k || ((c.sc_indicator = "arrow"), "reverse" !== c.navigation.mouseScrollReverse && ((c.sc_indicator_dir = 1), b.callingNewSlide(a, -1)), (m = !1)),
                  l || ((c.sc_indicator = "arrow"), "reverse" === c.navigation.mouseScrollReverse && ((c.sc_indicator_dir = 0), b.callingNewSlide(a, 1)), (m = !1)))
                : h.pixelY > e &&
                  (l || ((c.sc_indicator = "arrow"), "reverse" !== c.navigation.mouseScrollReverse && ((c.sc_indicator_dir = 0), b.callingNewSlide(a, 1)), (m = !1)),
                  k || ((c.sc_indicator = "arrow"), "reverse" === c.navigation.mouseScrollReverse && ((c.sc_indicator_dir = 1), b.callingNewSlide(a, -1)), (m = !1)))
              : (m = !1);
          ...
          return (
            "carousel" != c.navigation.mouseScrollNavigation
              ? ("reverse" !== c.navigation.mouseScrollReverse && ((n > 0 && h.pixelY > 0) || (o < jQuery(window).height() && h.pixelY < 0)) && (m = !0),
                "reverse" === c.navigation.mouseScrollReverse && ((n < 0 && h.pixelY < 0) || (o > jQuery(window).height() && h.pixelY > 0)) && (m = !0))
              : (m = !1),
              ...
              switch (((d.dragStartedOverSlider = !0), (h = g && g.match(/left|up/g) ? Math.round(h * -1) : (h = Math.round(1 * h))), e)) {
                ...
                case "move":
                  if ((d.c.find(".tp-withaction").addClass("tp-temporarydisabled"), (f.slide_offset = "off" === f.infinity ? f.slide_globaloffset + h : b.simp(f.slide_globaloffset + h, f.maxwidth)), "off" === f.infinity)) {
                    ...
                    ("none" !== f.overpull && 0 !== f.overpull) || !(s < 0 || s > d.slideamount - 1)
                      ? s >= 0 && s <= d.slideamount - 1 && ((s >= 0 && h > f.overpull) || (s <= d.slideamount - 1 && h < f.overpull)) && (f.overpull = 0)
                      : (f.overpull = h),
                      (f.slide_offset =
                        s < 0
                          ? f.slide_offset + (f.overpull - h) / 1.1 + Math.sqrt(Math.abs((f.overpull - h) / 1.1))
                          : s > d.slideamount - 1
                          ? f.slide_offset + (f.overpull - h) / 1.1 - Math.sqrt(Math.abs((f.overpull - h) / 1.1))
                          : f.slide_offset);
                  }
              ...
              switch (e) {
                ...
                case "move":
                  ...
                  (F = F < G ? ("horizontal" === A ? F + (((z.width() * (F - G)) / z.width()) * (F - G)) / z.width() : F + (((z.height() * (F - G)) / z.height()) * (F - G)) / z.height()) : F),
                    "vertical" === A ? punchgs.TweenLite.set(z, { top: F + "px" }) : punchgs.TweenLite.set(z, { left: F + "px" });
                  break;
                case "end":
                case "cancel":
                  if (r)
                    return (
                      (F = E + h),
                      (F = "vertical" === A ? (F < 0 - (z.height() - y.height()) ? 0 - (z.height() - y.height()) : F) : F < 0 - (z.width() - y.width()) ? 0 - (z.width() - y.width()) : F),
                      (F = F > 0 ? 0 : F),
                      (F = Math.abs(h) > D / 10 ? (h <= 0 ? Math.floor(F / D) * D : Math.ceil(F / D) * D) : h < 0 ? Math.ceil(F / D) * D : Math.floor(F / D) * D),
                      (F = "vertical" === A ? (F < 0 - (z.height() - y.height()) ? 0 - (z.height() - y.height()) : F) : F < 0 - (z.width() - y.width()) ? 0 - (z.width() - y.width()) : F),
                      (F = F > 0 ? 0 : F),
                      "vertical" === A ? punchgs.TweenLite.to(z, 0.5, { top: F + "px", ease: punchgs.Power3.easeOut }) : punchgs.TweenLite.to(z, 0.5, { left: F + "px", ease: punchgs.Power3.easeOut }),
                      (F = F ? F : "vertical" === A ? z.position().top : z.position().left),
                      z.data("offset", F),
                      z.data("distance", h),
                      setTimeout(function () {
    ...
    l = function (a) {
      (a.hide_delay = jQuery.isNumeric(parseInt(a.hide_delay, 0)) ? a.hide_delay / 1e3 : 0.2), (a.hide_delay_mobile = jQuery.isNumeric(parseInt(a.hide_delay_mobile, 0)) ? a.hide_delay_mobile / 1e3 : 0.2);
    },
    m = function (a) {
      return a && a.enable;
    },
        ...
        g =
          "layergrid" == b.container
            ? "fullscreen" == c.sliderLayout
              ...
              : "on" == c.autoHeight || (void 0 != c.minHeight && c.minHeight > 0)
              ? f / 2 - (c.gridheight[c.curWinRange] * c.bh) / 2
              : 0
            : 0,
        h =
          "top" === b.v_align ? { top: "0px", y: Math.round(b.v_offset + g) + "px" } : "center" === b.v_align ? { top: "50%", y: Math.round(0 - d / 2 + b.v_offset) + "px" } : { top: "100%", y: Math.round(0 - (d + b.v_offset + g)) + "px" };
    ...
    t = function (a, b, c) {
      ...
      if (
        (r(a, b, c),
        s(a, b, c),
        "outer-left" !== b.position || ("fullwidth" != b.sliderLayout && "fullscreen" != b.sliderLayout)
          ? "outer-right" !== b.position || ("fullwidth" != b.sliderLayout && "fullscreen" != b.sliderLayout) || punchgs.TweenLite.set(a, { right: 0 - a.outerWidth() + "px", x: b.h_offset + "px" })
          : punchgs.TweenLite.set(a, { left: 0 - a.outerWidth() + "px", x: b.h_offset + "px" }),
        ...
        h > e && "outer-left" !== b.position && "outer-right" !== b.position
          ? (punchgs.TweenLite.set(a, { left: "0px", x: 0, maxWidth: e - 2 * g + "px" }), punchgs.TweenLite.set(j, { maxWidth: e - 2 * g + "px" }))
          : (punchgs.TweenLite.set(a, { maxWidth: h + "px" }), punchgs.TweenLite.set(j, { maxWidth: h + "px" })),
          i + 2 * g > f && "outer-bottom" !== b.position && "outer-top" !== b.position
            ? (punchgs.TweenLite.set(a, { top: "0px", y: 0, maxHeight: k + l + (f - 2 * g) + "px" }), punchgs.TweenLite.set(j, { maxHeight: k + l + (f - 2 * g) + "px" }))
            : (punchgs.TweenLite.set(a, { maxHeight: i + "px" }), punchgs.TweenLite.set(j, { maxHeight: i + "px" })),
          "outer-left" !== b.position && "outer-right" !== b.position && ((k = 0), (l = 0)),
          b.span === !0 && "vertical" === b.direction
            ? (punchgs.TweenLite.set(a, { maxHeight: k + l + (f - 2 * g) + "px", height: k + l + (f - 2 * g) + "px", top: 0 - k, y: 0 }), r(j, b, c))
            : b.span === !0 && "horizontal" === b.direction && (punchgs.TweenLite.set(a, { maxWidth: "100%", width: e - 2 * g + "px", left: 0, x: 0 }), s(j, b, c));
      }
    },
    u = function (a, b, c, d) {
      ...
      "vertical" === b.direction
        ? (h.css({ top: (i - 1) * k + "px", left: "0px" }), e.css({ height: (i - 1) * k + h.outerHeight(), width: h.outerWidth() }))
        : (h.css({ left: (i - 1) * j + "px", top: "0px" }), e.css({ width: (i - 1) * j + h.outerWidth(), height: h.outerHeight() })),
        h.find(".tp-bullet-image").css({ backgroundImage: "url(" + d.thumbs[c.index()].src + ")" }),
        h.data("liref", f),
        h.click(function () {
    ...
    w = function (a, b, c, d, e) {
      ...
      u.find(j).css({ backgroundImage: "url(" + e.thumbs[c.index()].src + ")" }),
        "vertical" === b.direction
          ? (u.css({ top: (w - 1) * y + "px", left: "0px" }), p.css({ height: (w - 1) * y + u.outerHeight(), width: u.outerWidth() }))
          : (u.css({ left: (w - 1) * x + "px", top: "0px" }), p.css({ width: (w - 1) * x + u.outerWidth(), height: u.outerHeight() })),
        n.data("maxw", q),
        n.data("maxh", r),
      ...
      o.css({ maxWidth: q + "px", maxHeight: r + "px", overflow: "hidden", position: "relative" }),
        n.css({ maxWidth: q + "px", maxHeight: r + "px", overflow: "visible", position: z, background: v(b.wrapper_color, b.wrapper_opacity), padding: b.wrapper_padding + "px", boxSizing: "contet-box" }),
        u.click(function () {
