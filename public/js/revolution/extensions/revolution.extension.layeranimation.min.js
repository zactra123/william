...
!(function (a) {
  ...
  var b = jQuery.fn.revolution,
    d = (b.is_mobile(), { alias: "LayerAnimation Min JS", name: "revolution.extensions.layeranimation.min.js", min_core: "5.3.0", version: "3.4.4" });
  jQuery.extend(!0, b, {
    updateMarkup: function (a, b) {
      ...
      if (void 0 !== c.start && !c.frames_added && void 0 === c.frames) {
        ...
        jQuery.isNumeric(c.end) && jQuery.isNumeric(c.start) && jQuery.isNumeric(e.speed) && (c.end = parseInt(c.end, 0) - (parseInt(c.start, 0) + parseFloat(e.speed, 0))),
          d.push({ frame: "0", delay: c.start, from: c.transform_in, to: c.transform_idle, split: c.splitin, speed: e.speed, ease: e.anim.ease, mask: c.mask_in, splitdelay: c.elementdelay }),
          d.push({ frame: "5", delay: c.end, to: c.transform_out, split: c.splitout, speed: g.speed, ease: g.anim.ease, mask: c.mask_out, splitdelay: c.elementdelay }),
          c.transform_hover && d.push({ frame: "hover", to: c.transform_hover, style: c.style_hover, speed: h.speed, ease: h.anim.ease, splitdelay: c.elementdelay }),
          (c.frames = d);
      }
      if (!c.frames_added) {
      ...
      void 0 != e &&
        ...
        (1 == f || "true" == f || "on" == f || "1sttime" == f || g
          ? (("carousel" !== c.sliderType ||
              ("carousel" === c.sliderType && "on" === c.carousel.showLayersAllTime && a.closest("li").hasClass("active-revslide")) ||
              ("carousel" === c.sliderType && "on" !== c.carousel.showLayersAllTime && a.closest("li").hasClass("active-revslide"))) &&
              b.playVideo(a, c),
            b.toggleState(a.data("videotoggledby")),
            (g || "1sttime" == f) && ((d.autoplayonlyfirsttime = !1), (d.autoplay = "off")))
          : ("no1sttime" == f && (d.datasetautoplay = "on"), b.unToggleState(a.data("videotoggledby"))));
    },
      ...
      void 0 !== l &&
        ...
        jQuery.each(c.layers[l], function (a, d) {
          ...
          b.updateMarkup(this, c),
            ...
            (h && 0 !== i) || b.buildFullTimeLine({ caption: e, opt: c, offsetx: j, offsety: k, index: a, recall: f, preset: h, regenerate: 0 === i }),
              ...
              jQuery.each(c.timelines[l].layers, function (a, d) {
                ...
                ("none" !== d.wrapper && void 0 !== d.wrapper) ||
                  ("keep" == d.triggerstate && "on" === e.triggerstate
                    ? b.playAnimationFrame({ caption: d.layer, opt: c, frame: "frame_0", triggerdirection: "in", triggerframein: "frame_0", triggerframeout: "frame_999" })
              ...
              jQuery.each(c.timelines.staticlayers.layers, function (a, d) {
                ...
                e.hoveredstatus !== !0 &&
                  ...
                  (void 0 !== j &&
                    k &&
                    ("keep" == p
                      ? (b.playAnimationFrame({ caption: d.layer, opt: c, frame: "frame_0", triggerdirection: "in", triggerframein: "frame_0", triggerframeout: "frame_999" }), e.triggeredtimeline.time(j))
                      : e.hoveredstatus !== !0 && d.timeline.time(j)),
                  "reset" === p && "hidden" === o && (d.timeline.time(0), (e.animdirection = "out")),
                  f
                    ? k
                      ? n === d.lastslide && (d.timeline.play(i), (e.animdirection = "in"))
                      : (l || "in" === e.animdirection || d.timeline.play(h), (("visible" == o && "keep" !== p) || ("keep" === p && k === !0) || ("visible" == o && void 0 === k)) && (d.timeline.play(h + 0.01), (e.animdirection = "in")))
    ...
    prepareSingleCaption: function (a) {
      ...
      if (
        ...
        (d._lig =
          void 0 === d._lig ? (c.hasClass("rev_layer_in_group") ? c.closest(".rev_group") : c.hasClass("rev_layer_in_column") ? c.closest(".rev_column_inner") : c.hasClass("rev_column_inner") ? c.closest(".rev_row") : "none") : d._lig),
        ...
        void 0 === d._li && (c.hasClass("tp-static-layer") ? ((d._isstatic = !0), (d._li = c.closest(".tp-static-layers")), (d._slideid = "staticlayers")) : (d._li = c.closest(".tp-revslider-slidesli"))),
      ...
      if (
        ("off" === m || (d._gw < e.hideCaptionAtLimit && "on" == d.captionhidden) || d._gw < e.hideAllCaptionAtLimit ? d._pw.addClass("tp-hidden-caption") : d._pw.removeClass("tp-hidden-caption"),
        (d.layertype = "html"),
        ...
        (q = void 0 === q ? 0 : q),
          (t = void 0 === t ? 0 : t),
          "off" !== d._responsive
            ? ("grid" != d._ba && x ? (jQuery.isNumeric(q) ? n.css({ width: q + "px" }) : n.css({ width: q })) : jQuery.isNumeric(q) ? n.css({ width: q * e.bw + "px" }) : n.css({ width: q }),
              "grid" != d._ba && y ? (jQuery.isNumeric(t) ? n.css({ height: t + "px" }) : n.css({ height: t })) : jQuery.isNumeric(t) ? n.css({ height: t * e.bh + "px" }) : n.css({ height: t }))
            : n.css({ width: q, height: t }),
          d._ingroup &&
            (void 0 !== q && !jQuery.isNumeric(q) && q.indexOf("%") > 0 && punchgs.TweenLite.set([d._lw, d._pw, d._mw], { minWidth: q }),
            void 0 !== t && !jQuery.isNumeric(t) && t.indexOf("%") > 0 && punchgs.TweenLite.set([d._lw, d._pw, d._mw], { minHeight: t }));
      }
      ...
      if (c.hasClass("tp-videolayer") || c.hasClass("tp-audiolayer") || c.find("iframe").length > 0 || c.find(B).length > 0) {
        ...
        n.css({ display: "block" }), void 0 == c.data("videowidth") && (c.data("videowidth", n.width()), c.data("videoheight", n.height()));
        ...
        if (("auto" == G.lineHeight && (G.lineHeight = G.fontSize + 4), c.hasClass("fullscreenvideo") || F)) {
          ...
          var H = d._gh;
          "on" == e.autoHeight && (H = e.conh), c.css({ width: d._gw, height: H });
        } else
        ...
        ((0 == E && !F) || (1 != d.forcecover && !c.hasClass("fullscreenvideo") && !F)) && (n.width(q), n.height(t)),
          d._ingroup && void 0 !== d.videowidth && !jQuery.isNumeric(d.videowidth) && d.videowidth.indexOf("%") > 0 && punchgs.TweenLite.set([d._lw, d._pw, d._mw], { minWidth: d.videowidth });
      }
      ...
      var S = c.css("z-Index");
      if ("row" !== d._nctype && "column" !== d._nctype) punchgs.TweenLite.set(d._pw, { zIndex: S, top: d.calcy, left: d.calcx, overwrite: "auto" });
      else if ("row" !== d._nctype) punchgs.TweenLite.set(d._pw, { zIndex: S, width: d.columnwidth, top: 0, left: 0, overwrite: "auto" });
      else if ("row" === d._nctype) {
        var T = "grid" === d._ba ? Q + "px" : "100%";
        punchgs.TweenLite.set(d._pw, { zIndex: S, width: T, top: 0, left: a.offsetx, overwrite: "auto" });
      }
      void 0 !== d.blendmode && punchgs.TweenLite.set(d._pw, { mixBlendMode: d.blendmode }),
        ...
        d._ingroup &&
          (void 0 !== d._groupw && !jQuery.isNumeric(d._groupw) && d._groupw.indexOf("%") > 0 && punchgs.TweenLite.set([d._lw, d._pw, d._mw], { minWidth: d._groupw }),
          void 0 !== d._grouph && !jQuery.isNumeric(d._grouph) && d._grouph.indexOf("%") > 0 && punchgs.TweenLite.set([d._lw, d._pw, d._mw], { minHeight: d._grouph }));
    },
    createTimelineStructure: function (a) {
      function b(a, b, c, d) {
        ...
        (c = c || new Object()),
          ...
          "staticlayers" === d && ((c[a.attr("id")].firstslide = a.data("startslide")), (c[a.attr("id")].lastslide = a.data("endslide"))),
          a.data("slideid", d),
          (c[a.attr("id")].defclasses = f = a[0].className),
          (c[a.attr("id")].wrapper =
            f.indexOf("rev_layer_in_column") >= 0 ? a.closest(".rev_column_inner") : f.indexOf("rev_column_inner") >= 0 ? a.closest(".rev_row") : f.indexOf("rev_layer_in_group") >= 0 ? a.closest(".rev_group") : "none"),
      ...
      if (((k = f.timelines[d._slideid].layers[d._id]), !k.generated || a.regenerate === !0)) {
        if (
          ...
          void 0 !== d.current_timeline && a.regenerate !== !0
            ? ((d.current_timeline_pause = d.current_timeline.paused()), (d.current_timeline_time = d.current_timeline.time()), (d.current_is_nc_timeline = l === d.current_timeline), (d.static_layer_timeline_time = d.current_timeline_time))
            : ((d.static_layer_timeline_time = d.current_timeline_time), (d.current_timeline_time = 0), d.current_timeline && d.current_timeline.clear()),
          l.clear(),
          ...
          c.hover(
            function (a) {
              var b = { caption: jQuery(a.currentTarget), opt: f, firstframe: "frame_0", lastframe: "frame_999" },
                d = (e(b), b.caption),
                g = d.data(),
              ...
              (g.forcehover = h.force),
                j &&
                  ...
                  (g.hoverzIndex || (g.hoveranim.anim && g.hoveranim.anim.zIndex)) &&
                    ((g.basiczindex = void 0 === g.basiczindex ? g.cssobj.zIndex : g.basiczindex),
                    ...
                    (g.hovertimelines.pwhoveranim = punchgs.TweenLite.to(g._pw, h.speed / 1e3, { overwrite: "auto", zIndex: g.hoverzIndex })),
        ...
        for (var r = 0; r < d.frames.length; r++)
          if (r !== d.hoverframeindex) {
            ...
            (d.frames[r].framename = s), (k[s] = {}), (k[s].timeline = new punchgs.TimelineLite({ align: "normal" }));
            ...
            void 0 !== k.firstslide && "frame_0" === s && (l.addLabel("slide_" + k.firstslide + "_pause", 0), l.addPause("slide_" + k.firstslide + "_pause"), l.addLabel("slide_" + k.firstslide, "+=0.005")),
              void 0 !== k.lastslide && "frame_999" === s && (l.addLabel("slide_" + k.lastslide + "_pause", "+=0.01"), l.addPause("slide_" + k.lastslide + "_pause"), l.addLabel("slide_" + k.lastslide, "+=0.005")),
              jQuery.isNumeric(v) ? l.addLabel(s, "+=" + v) : (l.addLabel("pause_" + r, "+=0.01"), l.addPause("pause_" + r), l.addLabel(s, "+=0.01")),
              (l = b.createFrameOnTimeline({ caption: a.caption, timeline: l, label: s, frameindex: r, opt: f }));
          }
    ...
    createFrameOnTimeline: function (a) {
      ...
      if (
        ...
        "column" === d._nctype && (g.add(punchgs.TweenLite.set(d._cbgc_man, { display: "block" }), e), g.add(punchgs.TweenLite.set(d._cbgc_auto, { display: "none" }), e)),
        void 0 === d.mySplitText && d.splittext)
      ) {
        var s = c.find("a").length > 0 ? c.find("a") : c;
        (d.mySplitText = new punchgs.SplitText(s, { type: "chars,words,lines", charsClass: "tp-splitted tp-charsplit", wordsClass: "tp-splitted tp-wordsplit", linesClass: "tp-splitted tp-linesplit" })), c.addClass("splitted");
      }
      void 0 !== d.mySplitText && r && r.match(/chars|words|lines/g) && (k = d.mySplitText[r]);
      var y,
        z,
        t = h !== d.outframeindex ? m(f(), d.frames[h].to) : void 0 !== d.frames[h].to && null === d.frames[h].to.match(/auto:auto/g) ? m(i(), d.frames[h].to, 1 == j.sdir) : m(i(), d.frames[d.inframeindex].from, 0 == j.sdir),
        u = void 0 !== d.frames[h].from ? m(t, d.frames[d.inframeindex].from, 1 == j.sdir) : void 0,
        x = d.frames[h].splitdelay;
      if (
        (0 !== h || a.fromcurrentstate ? (z = n(d.frames[h].mask)) : (y = n(d.frames[h].mask)),
        (t.anim.ease = void 0 === d.frames[h].ease ? punchgs.Power1.easeInOut : d.frames[h].ease),
        void 0 !== u &&
          ((u.anim.ease = void 0 === d.frames[h].ease ? punchgs.Power1.easeInOut : d.frames[h].ease),
        ...
        c.data("iframes") && g.add(punchgs.TweenLite.set(c.find("iframe"), { autoAlpha: 1 }), e + "+=0.001"),
        h === d.outframeindex &&
      ...
      return (
        ...
        void 0 === z ||
          ...
          ((z.anim.ease = void 0 === z.anim.ease || "inherit" === z.anim.ease ? d.frames[0].ease : z.anim.ease),
        ...
        (0 === h && y && y !== !1 && !a.fromcurrentstate) || (0 === h && a.ignorefirstframe)
          ? ((z = new Object()),
            (z.anim = new Object()),
            ...
            y &&
              y !== !1 &&
              ((y.anim.x = y.anim.x * j.bw || l(y.anim.x, j, d.eow, d.eoh, d.calcy, d.calcx, "horizontal")), (y.anim.y = y.anim.y * j.bw || l(y.anim.y, j, d.eow, d.eoh, d.calcy, d.calcx, "vertical")), (y.anim.overflow = "hidden")))
          : 0 === h && g.add(o.mask.set(d._mw, { overflow: "visible" }), e),
        ...
        o.content.eventCallback(
          ...
          function (a, c, d, e, f, g, h, i) {
            ...
            if (
              ...
              if (0 === a) for (var l = 0; l < c.dchildren.length; l++) jQuery(c.dchildren[l]).data("timeline").play(0);
              else if (a === e.outframeindex) for (var l = 0; l < c.dchildren.length; l++) b.endMoveCaption({ caption: jQuery(c.dchildren[l]), opt: j, checkchildrens: !0 });
        ...
        o.content.eventCallback(
          ...
          function (a, d, e, f, g, h, i) {
            ...
            (k.layer = c),
              ...
              "column" === g._nctype && (punchgs.TweenLite.set(g._cbgc_man, { display: "none" }), punchgs.TweenLite.set(g._cbgc_auto, { display: "block" })),
              "leftstage" === k.eventtype && ((g.active = !1), punchgs.TweenLite.set(f, { visibility: "hidden", overwrite: "auto" }), (g.animdirection = "out"), (g.visibleelement = !1), b.unToggleState(g.layertoggledby)),
              (g.current_frame = a),
      ...
      if (
        (void 0 !== a.frame
          ...
          : (!c.static || a.currentslide >= c.removeonslide || a.currentslide < c.showonslide) &&
            ...
            c.timeline.pause(),
            d.visibleelement === !0 && b.createFrameOnTimeline({ caption: a.caption, timeline: c.outnow, label: "outnow", frameindex: a.caption.data("outframeindex"), opt: a.opt, fromcurrentstate: !0 }).play()),
        a.checkchildrens && c.timeline_obj && c.timeline_obj.dchildren && "none" !== c.timeline_obj.dchildren && c.timeline_obj.dchildren.length > 0)
      )
        for (var f = 0; f < c.timeline_obj.dchildren.length; f++) b.endMoveCaption({ caption: jQuery(c.timeline_obj.dchildren[f]), opt: a.opt });
    },
    playAnimationFrame: function (a) {
      ...
      d.triggeredtimeline = b.createFrameOnTimeline({ caption: a.caption, timeline: d.triggeredtimeline, label: "triggered", frameindex: f, updateStaticTimeline: !0, opt: a.opt, ignorefirstframe: !0, fromcurrentstate: i }).play();
    },
      ...
      g &&
        jQuery.each(g, function (a) {
          ...
          "carousel" === c.sliderType && "on" === c.carousel.showLayersAllTime
            ? (clearTimeout(d.data("videoplaywait")), b.stopVideo && b.stopVideo(d, c), b.removeMediaFromList && b.removeMediaFromList(d, c), (c.lastplayedvideos = []))
            : (x(d), clearTimeout(d.data("videoplaywait")), b.endMoveCaption({ caption: d, opt: c, currentslide: h }), b.removeMediaFromList && b.removeMediaFromList(d, c), (c.lastplayedvideos = []));
        });
    },
  });
  var e = function (a) {
      ...
      return (
        ...
        b.static && ((b.showonslide = b.timeline_obj.firstslide), (b.removeonslide = b.timeline_obj.lastslide)),
        b
      );
    },
    f = function (a) {
    ...
    l = function (a, b, c, d, e, f, g) {
      return (
        !jQuery.isNumeric(a) && a.match(/%]/g)
          ? ((a = a.split("[")[1].split("]")[0]), "horizontal" == g ? (a = ((c + 2) * parseInt(a, 0)) / 100) : "vertical" == g && (a = ((d + 2) * parseInt(a, 0)) / 100))
    ...
    r = function (a, b) {
      var e,
        ...
        d = !1;
      if (
        ("rekursive" == b && ((e = a.closest(".tp-caption")), e && a.css("fontSize") === e.css("fontSize") && (d = !0)),
        ...
        jQuery.inArray(a.data("layertype"), ["video", "image", "audio"]) !== -1 || a.is("img")
          ? (c.lineHeight = 0)
          : (c.lineHeight = d ? (void 0 === e.data("lineheight") ? parseInt(e.css("lineHeight"), 0) || 0 : e.data("lineheight")) : void 0 === a.data("lineheight") ? parseInt(a.css("lineHeight"), 0) || 0 : a.data("lineheight")),
        (c.letterSpacing = d
        ...
        if (
          ((c.color = void 0 === a.data("color") ? "nopredefinedcolor" : a.data("color")),
      ...
      if (("off" === d && ((g = 1), (h = 1)), "auto" == f.lineHeight && (f.lineHeight = f.fontSize + 4), !a.hasClass("tp-splitted"))) {
        ...
        if (
          ...
          if (
            ...
            punchgs.TweenLite.set(a, { maxWidth: l, maxHeight: m, minWidth: n, minHeight: o, whiteSpace: f.whiteSpace, textAlign: f.textAlign, overwrite: "auto" }),
            "nopredefinedcolor" != f.color && punchgs.TweenLite.set(a, { color: f.color, overwrite: "auto" }),
            void 0 != e.svg_src)
          ) {
            var p =
              "nopredefinedcolor" != f.color && void 0 != f.color
                ? f.color
                : void 0 != f.css && "nopredefinedcolor" != f.css.color && void 0 != f.css.color
                ? f.css.color
                : void 0 != f.styleProps.color
                ? f.styleProps.color
                : void 0 != f.styleProps.css && void 0 != f.styleProps.css.color && f.styleProps.css.color;
            0 != p && (punchgs.TweenLite.set(a.find("svg"), { fill: p, overwrite: "auto" }), punchgs.TweenLite.set(a.find("svg path"), { fill: p, overwrite: "auto" }));
          }
        }
        "column" === e._nctype &&
          (void 0 === e._column_bg_set &&
            ...
            punchgs.TweenLite.set(a, { backgroundColor: "transparent", backgroundImage: "" })),
          setTimeout(function () {
            v(a, b);
          }, 1),
          e._cbgc_auto &&
    ...
    v = function (a, b) {
      ...
      if (c._cbgc_man) {
        ...
        jQuery.isArray(c.cssobj.marginLeft)
          ? ((d = c.cssobj.marginLeft[b.curWinRange] * b.bw), (e = c.cssobj.marginTop[b.curWinRange] * b.bh), (f = c.cssobj.marginBottom[b.curWinRange] * b.bh), (g = c.cssobj.marginRight[b.curWinRange] * b.bw))
          : ((d = c.cssobj.marginLeft * b.bw), (e = c.cssobj.marginTop * b.bh), (f = c.cssobj.marginBottom * b.bh), (g = c.cssobj.marginRight * b.bw)),
    ...
    w = function (a, b) {
      ...
      if (a.hasClass("rs-pendulum") && void 0 == c._loop_timeline) {
        ...
        (d *= b),
          (e *= b),
          c._loop_timeline.append(new punchgs.TweenLite.fromTo(a, f, { force3D: "auto", rotation: d, transformOrigin: g }, { rotation: e, ease: h })),
      ...
      if (a.hasClass("rs-slideloop") && void 0 == c._loop_timeline) {
        ...
        (i *= b),
          ...
          (k *= b),
          (l *= b),
          c._loop_timeline.append(new punchgs.TweenLite.fromTo(a, f, { force3D: "auto", x: i, y: j }, { x: k, y: l, ease: h })),
          c._loop_timeline.append(
            new punchgs.TweenLite.fromTo(
              a,
              f,
      ...
      if (a.hasClass("rs-pulse") && void 0 == c._loop_timeline) {
        ...
        var m = void 0 == a.data("zoomstart") ? 0 : a.data("zoomstart"),
          ...
          f = void 0 == a.data("speed") ? 2 : a.data("speed"),
          h = void 0 == a.data("easing") ? punchgs.Power2.easeInOut : a.data("easing");
        c._loop_timeline.append(new punchgs.TweenLite.fromTo(a, f, { force3D: "auto", scale: m }, { scale: n, ease: h })),
          c._loop_timeline.append(
            new punchgs.TweenLite.fromTo(
              a,
              f,
      ...
      if (a.hasClass("rs-wave") && void 0 == c._loop_timeline) {
        ...
        var s = (parseInt(r.x, 0) / 100 - 0.5) * a.width(),
          ...
          x = parseInt(o, 0),
          y = new punchgs.TweenLite.fromTo(w, f, { a: 0 + x }, { a: 360 + x, force3D: "auto", ease: punchgs.Linear.easeNone });
        y.eventCallback(
          "onUpdate",
          function (a) {
            ...
            punchgs.TweenLite.to(a.element, 0.1, { force3D: "auto", x: d, y: c });
          },
          [w]
        ),
          y.eventCallback(
