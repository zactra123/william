      ...
      var c,
        ...
        r = function (a) {
          var b,
            h,
            i = A() - B;
          i > o && (k += i - p), (B += i), (j.time = (B - k) / 1e3), (b = j.time - g), (!c || b > 0 || a === !0) && (j.frame++, (g += b + (b >= f ? 0.004 : f - b)), (h = !0)), a !== !0 && (e = d(r)), h && j.dispatchEvent(q);
        };
      x.call(j),
        (j.time = j.frame = 0),
        (j.tick = function () {
    ...
    D(),
      ...
      (g.duration = function (a) {
        return arguments.length
          ? ((this._duration = this._totalDuration = a), this._uncache(!0), this._timeline.smoothChildTiming && this._time > 0 && this._time < this._duration && 0 !== a && this.totalTime(this._totalTime * (a / this._duration), !0), this)
          ...
          (k = f[h]),
            ...
            k === e[h] || e.length <= h
              ...
              : (n && (l.push(n), (n = "")),
                (g = parseFloat(e[h])),
                l.push(g),
                (l._firstPT = { _next: l._firstPT, t: l, p: l.length - 1, s: g, c: ("=" === k.charAt(1) ? parseInt(k.charAt(0) + "1", 10) * parseFloat(k.substr(2)) : parseFloat(k) - g) || 0, f: 0, m: o && 4 > o ? Math.round : 0 })),
            (m += k.length);
      ...
      return (
        ...
        (d.render = function (t, e, i) {
          ...
          if (t >= u)
            ...
            if (
              ((this._totalTime = this._time = 0), (0 !== f || (0 === this._duration && this._rawPrevTime !== r && (this._rawPrevTime > 0 || (0 > t && this._rawPrevTime >= 0)))) && ((o = "onReverseComplete"), (n = this._reversed)), 0 > t)
            )
      ...
      var za,
        ...
        Oa = function (a, b) {
          ...
          if (
            ...
            return Na;
          for (e = (d || "").match(s) || [], va = e.length; --va > -1; ) (f = Number(e[va])), (e[va] = (g = f - (f |= 0)) ? ((g * j + (0 > g ? -0.5 : 0.5)) | 0) / j + f : f);
          ...
          if ((n && ((p = 1e-4), p > E && E > -p && (E = G = 2e-5), p > F && F > -p && (F = G = 2e-5), !M || z.z || z.rotationX || z.rotationY || (M = 0)), B || z.skewX))
            (B *= K),
              ...
              z.skewX &&
                ...
                (q = Math.cos(B)),
                (r = Math.sin(B)),
                "simple" === z.skewType && ((s = Math.tan((z.skewX - z.skewY) * K)), (s = Math.sqrt(1 + s * s)), (q *= s), (r *= s), z.skewY && ((s = Math.tan(z.skewY * K)), (s = Math.sqrt(1 + s * s)), (b *= s), (e *= s)))),
              (c = -r),
              (f = q);
          else {
            if (!(D || C || 1 !== G || M || L))
              return void (A[Ba] =
                (z.xPercent || z.yPercent ? "translate(" + z.xPercent + "%," + z.yPercent + "%) translate3d(" : "translate3d(") + H + "px," + I + "px," + J + "px)" + (1 !== E || 1 !== F ? " scale(" + E + "," + F + ")" : ""));
            (b = f = 1), (c = e = 0);
          }
          (j = 1),
            (d = g = h = i = k = l = 0),
            ...
            C || D || 1 !== G
              ? ((u += v + (p > i && i > -p ? w : i) + v + (p > l && l > -p ? w : l) + v + (p > d && d > -p ? w : d)), (u += v + (p > g && g > -p ? w : g) + v + (p > j && j > -p ? w : j) + v + (p > m && m > -p ? w : m) + v))
              : (u += ",0,0,0,0,1,0,"),
            ...
            parser: function (a, b, c, d, f, h, i) {
              ...
              if (((d._transform = C), D && "string" == typeof D && Ba))
                (l = P.style),
                  ...
                  C.svg &&
                    ...
                    (k.x -= C.xOffset),
                    (k.y -= C.yOffset),
                    (z.transformOrigin || z.svgOrigin) && ((D = {}), Ka(a, ga(z.transformOrigin), D, z.svgOrigin, z.smoothOrigin, !0), (p = D.xOrigin), (s = D.yOrigin), (k.x -= D.xOffset - C.xOffset), (k.y -= D.yOffset - C.yOffset)),
                ...
                "string" == typeof z.x && -1 !== z.x.indexOf("%") && ((k.x = 0), (k.xPercent = ia(z.x, C.xPercent))),
                  ...
                  Ea &&
                    ((k.rotationX = ja("rotationX" in z ? z.rotationX : "shortRotationX" in z ? z.shortRotationX + "_short" : C.rotationX || 0, C.rotationX, "rotationX", A)),
              ...
              return (
                ...
                C.svg &&
                  ...
                  (p !== C.xOffset || s !== C.yOffset) && ((f = ta(C, "xOffset", v ? p : C.xOffset, C.xOffset, f, B)), (f = ta(C, "yOffset", v ? s : C.yOffset, C.yOffset, f, B))),
                  (D = za ? null : "0px 0px")),
                (D || (Ea && m && C.zOrigin)) &&
                  (Ba
                    ? ((n = !0),
        ...
        xa("border", {
          ...
          parser: function (a, b, c, d, f, g) {
            var h = $(a, "borderTopWidth", e, !1, "0px"),
              ...
              j = i[0].replace(w, "");
            return (
              "px" !== j && (h = parseFloat(h) / _(a, "borderTopWidth", 1, j) + j), this.parseComplex(a.style, this.format(h + " " + $(a, "borderTopStyle", e, !1, "solid") + " " + $(a, "borderTopColor", e, !1, "#000")), i.join(" "), f, g)
            );
          },
          color: !0,
          formatter: function (a) {
                ...
                : ((m = $(a, g, e) + ""),
                  ...
                  "color" === g || "fill" === g || "stroke" === g || -1 !== g.indexOf("Color") || (s && A.test(n))
                    ...
                    : ((j = parseFloat(m)),
                      ...
                      ("" === m || "auto" === m) && ("width" === g || "height" === g ? ((j = fa(a, g, e)), (o = "px")) : "left" === g || "top" === g ? ((j = aa(a, g, e)), (o = "px")) : ((j = "opacity" !== g ? 0 : 1), (o = ""))),
                      (t = s && "=" === n.charAt(1)),
                      ...
                      o !== p &&
                        ...
                        j &&
                        ((j = _(a, g, j, o)),
                        "%" === p ? ((j /= _(a, g, 100, "%") / 100), b.strictUnits !== !0 && (m = j + "%")) : "em" === p || "rem" === p || "vw" === p || "vh" === p ? (j /= _(a, g, 1, p)) : "px" !== p && ((l = _(a, g, l, p)), (p = "px")),
                        t && (l || 0 === l) && (n = l + j + p)),
                      t && (l += j),
                      (!j && 0 !== j) || (!l && 0 !== l)
      ...
      (j._addLazySet = function (a, b, c) {
        ...
        (j._kill = function (b) {
          ...
          for (
            b.className &&
              (c = this._classNamePT) &&
              ((e = c.xfirst), e && e._prev ? this._linkCSSP(e._prev, c._next, e._prev._prev) : e === this._firstPT && (this._firstPT = c._next), c._next && this._linkCSSP(c._next, c._next._next, e._prev), (this._classNamePT = null)),
              c = this._firstPT;
            c;
...
!(function (a) {
  ...
  var b = a.GreenSockGlobals || a,
    ...
    u = function (a, b, c, d, h) {
      ...
      if (G || J)
        for (r = 0; j > r; r++)
          (x = w[r]),
            ...
            (o || J || (I && !H)) &&
              ((y = x.offsetTop),
              G && o && Math.abs(y - M) > U && "BR" !== x.nodeName && ((k = []), G.push(k), (M = y)),
              J && ((x._x = x.offsetLeft), (x._y = y), (x._w = x.offsetWidth), (x._h = x.offsetHeight)),
              G && ((H !== o && I) || (k.push(x), (x._x -= O)), o && r && (w[r - 1]._wordEnd = !0), "BR" === x.nodeName && x.nextSibling && "BR" === x.nextSibling.nodeName && G.push([])));
      for (r = 0; j > r; r++)
        (x = w[r]),
          (o = x.parentNode === a),
          "BR" !== x.nodeName
            ? (J &&
                ((A = x.style),
                H || o || ((x._x += x.parentNode._x), (x._y += x.parentNode._y)),
                (A.left = x._x + "px"),
                (A.top = x._y + "px"),
                (A.position = "absolute"),
                (A.display = "block"),
              ...
              H
                ...
                : !o && I && ((y = !G && !J && x.nextSibling), a.appendChild(x), y || a.appendChild(f.createTextNode(" ")), ca.push(x)))
            : G || J
            ? (a.removeChild(x), w.splice(r--, 1), j--)
            : H || a.appendChild(x);
      if (G) {
        for (J && ((z = f.createElement(E)), a.appendChild(z), (B = z.offsetWidth + "px"), (y = z.offsetParent === a ? 0 : a.offsetLeft), a.removeChild(z)), A = a.style.cssText, a.style.cssText = "display:none;"; a.firstChild; )
          a.removeChild(a.firstChild);
        for (C = " " === K && (!J || (!H && !I)), r = 0; r < G.length; r++) {
          for (k = G[r], z = f.createElement(E), z.style.cssText = "display:block;text-align:" + T + ";position:" + (J ? "absolute;" : "relative;"), _ && (z.className = _ + ($ ? r + 1 : "")), ea.push(z), j = k.length, u = 0; j > u; u++)
            "BR" !== k[u].nodeName &&
              ((x = k[u]),
              z.appendChild(x),
              C && (x._wordEnd || H) && z.appendChild(f.createTextNode(" ")),
              J && (0 === u && ((z.style.top = x._y + "px"), (z.style.left = O + y + "px")), (x.style.top = "0px"), y && (x.style.left = x._x - y + "px")));
      ...
      J && (V > a.clientHeight && ((a.style.height = V - R + "px"), a.clientHeight < V && (a.style.height = V + P + "px")), W > a.clientWidth && ((a.style.width = W - S + "px"), a.clientWidth < W && (a.style.width = W + Q + "px"))),
        t(c, ca),
        t(d, da),
        t(h, ea);
    },
