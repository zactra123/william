          ...
          (a.minHeight = a.minHeight != undefined ? parseInt(a.minHeight, 0) : a.minHeight),
            ...
            jQuery(this).on("scriptsloaded", function () {
              return a.modulesfailing
                ? (b.html('<div style="margin:auto;line-height:40px;font-size:14px;color:#fff;padding:15px;background:#e74c3c;margin:20px 0px;">!! Error at loading Slider Revolution 5.0 Extrensions.' + a.errorm + "</div>").show(), !1)
  ...
  var _ISM = _R.is_mobile(),
          ...
          a.find(".tp-caption, .rs-background-video-layer").each(function (a) {
            ...
            (d.startclasses = c.attr("class")),
              ...
              c.hasClass("tp-static-layer") &&
                ...
                (_R.handleStaticLayers(c, b), b.scrolleffect.on && (("on" === b.scrolleffect.on_parallax_static_layers && d.isparallaxlayer) || ("on" === b.scrolleffect.on_static_layers && !d.isparallaxlayer)) && (j = !0), (i = !1));
            ...
            if (
              ...
              "row" !== o && "group" !== o && "column" !== o
                ? ((s = "display:" + c.css("display") + ";"), c.closest(".rev_column").length > 0 ? (c.addClass("rev_layer_in_column"), (i = !1)) : c.closest(".rev_group").length > 0 && (c.addClass("rev_layer_in_group"), (i = !1)))
                : "column" === o && (i = !1),
                ...
                "column" === o && (c.append('<div class="rev_column_bg rev_column_bg_man_sized" style="display:none"></div>'), c.closest(".tp-parallax-wrap").append('<div class="rev_column_bg rev_column_bg_auto_sized"></div>'));
    ...
    contWidthManager = function (a) {
      ...
      if ("auto" == a.sliderLayout || ("fullscreen" === a.sliderLayout && "on" == a.fullScreenAutoWidth))
        "fullscreen" == a.sliderLayout && "on" == a.fullScreenAutoWidth ? punchgs.TweenLite.set(a.ul, { left: 0, width: a.c.width() }) : punchgs.TweenLite.set(a.ul, { left: b, width: a.c.width() - _R.getHorizontalOffset(a.c, "both") });
      else {
