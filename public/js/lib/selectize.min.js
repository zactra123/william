...
!(function (a, b) {
  ...
  var b = function (a, b) {
    ...
    g = { a: "[aÀÁÂÃÄÅàáâãäåĀā]", c: "[cÇçćĆčČ]", d: "[dđĐďĎ]", e: "[eÈÉÊËèéêëěĚĒē]", i: "[iÌÍÎÏìíîïĪī]", n: "[nÑñňŇ]", o: "[oÒÓÔÕÕÖØòóôõöøŌō]", r: "[rřŘ]", s: "[sŠš]", t: "[tťŤ]", u: "[uÙÚÛÜùúûüůŮŪū]", y: "[yŸÿýÝ]", z: "[zŽž]" };
  return a;
}),
  (function (a, b) {
      ...
      a.extend(L.prototype, {
        ...
        onOptionSelect: function (b) {
          ...
          b.preventDefault && (b.preventDefault(), b.stopPropagation()),
            ...
            d.hasClass("create")
              ? e.createItem()
              : ((c = d.attr("data-value")), "undefined" != typeof c && ((e.lastQuery = null), e.setTextboxValue(""), e.addItem(c), !e.settings.hideSelected && b.type && /mouse/.test(b.type) && e.setActiveOption(e.getOption(c))));
        },
        ...
        setActiveItem: function (b, c) {
          ...
          if ("single" !== l.settings.mode) {
            ...
            if (((d = c && c.type.toLowerCase()), "mousedown" === d && l.isShiftDown && l.$activeItems.length)) {
              for (
                k = l.$control.children(".active:last"), g = Array.prototype.indexOf.apply(l.$control[0].childNodes, [k[0]]), h = Array.prototype.indexOf.apply(l.$control[0].childNodes, [b[0]]), g > h && ((j = g), (g = h), (h = j)), e = g;
                h >= e;
                e++
              )
        ...
        refreshOptions: function (b) {
          ...
          for (n = [], c = 0, g = i.length; g > c; c++)
            (l = i[c]),
              t.optgroups.hasOwnProperty(l) && h[l].length ? ((o = t.render("optgroup_header", t.optgroups[l]) || ""), (o += h[l].join("")), n.push(t.render("optgroup", a.extend({}, t.optgroups[l], { html: o })))) : n.push(h[l].join(""));
        ...
        addOption: function (b) {
          ...
          else (e = y(b[f.settings.valueField])), "string" != typeof e || f.options.hasOwnProperty(e) || ((f.userOptions[e] = !0), (f.options[e] = b), (f.lastQuery = null), f.trigger("option_add", e, b));
        },
        ...
        clear: function () {
          var a = this;
          a.items.length &&
            (a.$control.children(":not(input)").remove(), (a.items = []), (a.lastQuery = null), a.setCaret(0), a.setActiveItem(null), a.updatePlaceholder(), a.updateOriginalInput(), a.refreshState(), a.showInput(), a.trigger("clear"));
        },
        ...
        deleteSelection: function (b) {
          ...
          if (((e = b && b.keyCode === p ? -1 : 1), (f = H(l.$control_input[0])), l.$activeOption && !l.settings.hideSelected && (i = l.getAdjacentOption(l.$activeOption, -1).attr("data-value")), (g = []), l.$activeItems.length)) {
            ...
            (l.isFocused || "single" === l.settings.mode) && l.items.length && (0 > e && 0 === f.start && 0 === f.length ? g.push(l.items[l.caretPos - 1]) : e > 0 && f.start === l.$control_input.val().length && g.push(l.items[l.caretPos]));
