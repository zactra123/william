...
*/
  ...
  q("Array.prototype.copyWithin", function (a) {
    ...
    return a
      ...
      : function (c, d, e) {
          ...
          else for (e = Math.min(e, f + d - c), c += e - d; e > d; ) --e in this ? (this[--c] = this[e]) : delete this[--c];
          return this;
        };
  });
  q("Symbol", function (a) {
  ...
  q("Map", function (a) {
    ...
    e.prototype.set = function (h, k) {
      ...
      m.l ? (m.l.value = k) : ((m.l = { next: this.a, s: this.a.s, head: this.a, key: h, value: k }), m.list.push(m.l), (this.a.s.next = m.l), (this.a.s = m.l), this.size++);
      return this;
    };
  ...
  J.f.I = {
    ...
    Ha: { d3: { subdir1: "d3", subdir2: "v5", filename: "d3.js" }, "d3.sankey": { subdir1: "d3_sankey", subdir2: "v4", filename: "d3.sankey.js" }, webfontloader: { subdir: "webfontloader", filename: "webfont.js" } },
...
*/
  ...
  J.f.J = { 1: "1.0", "1.0": "current", "1.1": "upcoming", "1.2": "testing", 41: "pre-45", 42: "pre-45", 43: "pre-45", 44: "pre-45", 46: "46.1", "46.1": "46.2", 48: "48.1", current: "49", upcoming: "49", testing: "49" };
  function sc(a, b) {
    this.b = {};
    this.a = [];
    this.c = 0;
  ...
  function wc(a) {
    ...
    var b;
    a instanceof wc
      ? ((this.i = a.i), xc(this, a.g), (this.j = a.j), (this.a = a.a), yc(this, a.m), (this.b = a.b), zc(this, Ac(a.c)), (this.h = a.h))
      : a && (b = String(a).match(uc))
      ? ((this.i = !1), xc(this, b[1] || "", !0), (this.j = Bc(b[2] || "")), (this.a = Bc(b[3] || "", !0)), yc(this, b[4]), (this.b = Bc(b[5] || "", !0)), zc(this, b[6] || "", !0), (this.h = Bc(b[7] || "")))
  ...
  l.C = function () {
    V(this);
    for (var a = this.a.D(), b = this.a.C(), c = [], d = 0; d < b.length; d++) for (var e = a[d], f = 0; f < e.length; f++) c.push(b[d]);
    return c;
  };
  l.D = function (a) {
    V(this);
  ...
  function Wc(a) {
    a = a || "";
    for (var b = a.replace(/-/g, "_").toLowerCase(); "string" === typeof b; ) (a = b), (b = J.f.W[b]), b === a && (b = !1);
