...
connectToChannel = function (user) {
  window.Echo.channel(`ReceptionistLiveChat.${user}`).listen("ReceptionistLiveChat", function (e) {
...
addChatUserList = function (chatUserList) {
  ...
  chatListHtml = chatListHtml
    .replace(/{recipient-identifier}/g, chatUserList.recipient_type + chatUserList.recipient_id)
