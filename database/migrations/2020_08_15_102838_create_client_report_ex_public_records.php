...
class CreateClientReportExPublicRecords extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('client_report_ex_public_records', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('client_report_ex_public_records');
    }
}
