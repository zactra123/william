...
class PricingChanges extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('disputes_pricings', function (Blueprint $table) {
            ...
            $table->float('p_loan_late')->nullable();
            $table->float('auto_late')->nullable();
            $table->float('mortgage_late')->nullable();
            $table->float('student_loan_late')->nullable();
            $table->float('public_record')->nullable();
            $table->float('cc_blocking')->nullable();
            $table->float('utility_blocking')->nullable();
            ...
            $table->float('unknown')->nullable();
            $table->json('collection')->nullable();
            $table->timestamps();
        });
        \Illuminate\Support\Facades\DB::table('disputes_pricings')->insert(["user_id" => null]);
    }
