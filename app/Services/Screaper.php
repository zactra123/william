        ...
        if(!empty($json['negativeTradeRecords'])){
            foreach($json['negativeTradeRecords'] as $infoNegativeTrade) {
                $dataAccount = [
                    ...
                    'credit_limit' => $infoNegativeTrade['creditLimitOrBalance'] == "Credit Limit" ? $infoPublicRecords['creditLimitOrBalance'] : null,
                    'original_balance' => $infoNegativeTrade['creditLimitOrBalance'] == "Original Balance" ? $infoPublicRecords['creditLimitOrBalance'] : null,
        ...
        if(!empty($json['positiveTradeRecords'])){
            foreach($json['positiveTradeRecords'] as $infoPositiveTrade) {
                $dataAccount = [
                    ...
                    'credit_limit' => $infoPositiveTrade['creditLimitOrBalance'] == "Credit Limit" ? $infoPublicRecords['creditLimitOrBalance'] : null,
                    'original_balance' => $infoPositiveTrade['creditLimitOrBalance'] == "Original Balance" ? $infoPublicRecords['creditLimitOrBalance'] : null,
...
//                dd($negativeAccount);
                $dataAccount = [
                    ...
                    'credit_limit_or_original_amount' => $negativeAccount['credit_limit'],
